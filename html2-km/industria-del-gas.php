...
$_sqlNoticias2 = "SELECT * from noticia Where cat_id = 2 ORDER BY no_fecha DESC";
...
$_sqlNoticias = "SELECT * from noticia Where cat_id = 2 ORDER BY no_fecha DESC LIMIT ".$inicio."," . $TAMANO_PAGINA;
