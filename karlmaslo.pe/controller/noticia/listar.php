...
$objnot 	= new Noticia();
$datanot 	= $objnot->dameListado($page,$filtro,0,0,$gIdioma);
...
// Imprimimos
$objnot 	= new Noticia();
$datanot 	= $objnot->dameListado($page,$filtro,$inicio,$TAMANO_PAGINA,$gIdioma);
...
for($i=0; $i<=$item; $i++){
	...
	if ($data['tca_cat_id'] == 1)
		$arrjson['listado'][$i]['urlcategoria'] 		= "innovacion";
	if ($data['tca_cat_id'] == 2)
		$arrjson['listado'][$i]['urlcategoria'] 		= "industria-del-gas";
	if ($data['tca_cat_id'] == 3)
		$arrjson['listado'][$i]['urlcategoria'] 		= "actualidad";
	if ($data['tca_cat_id'] == 5)
		$arrjson['listado'][$i]['urlcategoria'] 		= "seguridad";
