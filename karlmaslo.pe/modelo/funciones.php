...
class misFunciones {
	...
	function __destruct() {}
	function postFecha($data,$gIdioma){
		//echo $gIdioma;
		...
		if ($mes == "01"){
			$nombre_mes = "enero"; 
			$nombre_mes_en = "january"; 
		}
		if ($mes == "02"){
			$nombre_mes = "febrero"; 
			$nombre_mes_en = "february"; 
		}
		if ($mes == "03"){
			$nombre_mes = "marzo"; 
			$nombre_mes_en = "march"; 
		...
		if ($mes == "08"){
			$nombre_mes = "agosto"; 
			$nombre_mes_en = "august"; 
		}
		if ($mes == "09"){
			$nombre_mes = "septiembre"; 
			$nombre_mes_en = "september";
		}
		if ($mes == "10"){
			$nombre_mes = "octubre"; 
			$nombre_mes_en = "october"; 
		}
		if ($mes == "11"){
			$nombre_mes = "noviembre"; 
			$nombre_mes_en = "november"; 
		}
		if ($mes == "12"){
			$nombre_mes = "diciembre"; 
			$nombre_mes_en = "december"; 
		}
		if($gIdioma == "es"){
			return $dia." ". $nombre_mes .", ".$anno;
		}
		else{
			return $dia." ". $nombre_mes_en .", ".$anno;
		}
	}
