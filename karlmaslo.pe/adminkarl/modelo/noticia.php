...
class Noticia extends Conexion{
	function dameListado($page=NULL,$filtro=NULL,$inicio=NULL,$TAMANO_PAGINA=NULL){
		...
		$sql = "Select art_id, tca_cat_id, art_nombre,art_nombre_en, art_descripsuperior, art_descripinferior,art_frase, ";
	...
	function prodeceAregar($data=NULL){
		...
		$titulo_en 		= $this->limpiacadena($data['titulo_en']);
		$frase 			= $this->limpiacadena($data['frase']);
		$frase_en 		= $this->limpiacadena($data['frase_en']);
		...
		$descrip_superior_en = $this->limpiacadena($data['descrip_superior_en']);
		$descrip_inferior = $this->limpiacadena($data['descrip_inferior']);
		$descrip_inferior_en = $this->limpiacadena($data['descrip_inferior_en']);
		...
		$sql.= "art_nombre_en,art_descripsuperior_en,art_descripinferior_en,art_frase_en)  ";
		$sql.= "Values ";
		...
		$sql.= "'$titulo_en','$descrip_superior_en','$descrip_inferior_en','$frase_en')  ";
		//return $sql;
	...
	function hacerActualizacion($data=NULL){
		...
		$sql.= "art_nombre_en = '".$titulo_en."', ";
		$sql.= "art_order = ".$order.", ";
		$sql.= "art_descripsuperior = '".$descrip_superior."', ";
		$sql.= "art_descripsuperior_en = '".$descrip_superior_en."', ";
		$sql.= "art_descripinferior = '".$descrip_inferior."', ";
		$sql.= "art_descripinferior_en = '".$descrip_inferior_en."', ";
