...
$arrjson['titulo_en'] 			= $objfunc->verificarDataPost('titulo_en');
$arrjson['frase'] 				= $objfunc->verificarDataPost('frase');
$arrjson['frase_en'] 			= $objfunc->verificarDataPost('frase_en');
...
$arrjson['descrip_superior_en'] = $objfunc->verificarDataPost('descrip_superior_en');
$arrjson['descrip_inferior'] 	= $objfunc->verificarDataPost('descrip_inferior');
$arrjson['descrip_inferior_en'] = $objfunc->verificarDataPost('descrip_inferior_en');
$arrjson['tip_multimedia']      = "";
$arrjson['categoria']      		= $objfunc->verificarDataPost('categoria');
...
$arrjson['ruta'] = "../../resources/assets/image/noticia/";
