...
app.controller('editarBibliografiaCrtl', [
  '$scope', '$http', '$timeout', '$rootScope', '$routeParams', '$cookieStore', '$location', 'AuthenticationService', function(scope, http, timeout, rootScope, routeParams, cookieStore, location2, AuthenticationService) {
    ...
    scope.procesarForm = function(data) {
      ...
      scope.formData.append("titulo_en", data.titulo_en);
      scope.formData.append("frase", data.frase);
      scope.formData.append("frase_en", data.frase_en);
      ...
      scope.formData.append("descrip_superior_en", data.descrip_superior_en);
      scope.formData.append("descrip_inferior", data.descrip_inferior);
      scope.formData.append("descrip_inferior_en", data.descrip_inferior_en);
...
app.controller('editarNoticiaCrtl', [
  '$scope', '$http', '$timeout', '$rootScope', '$routeParams', '$cookieStore', '$location', 'AuthenticationService', function(scope, http, timeout, rootScope, routeParams, cookieStore, location2, AuthenticationService) {
    ...
    scope.formData = new FormData();
    scope.rutaImg = "resources/assets/image/noticia/";
    ...
    scope.validacion = function() {
      ...
      $("#frmnoti").validate({
        rules: {
          ...
          descrip_superior: "required",
          descrip_superior_en: "required",
          descrip_inferior: "required",
          descrip_inferior_en: "required",
        },
        messages: {
          titulo: "Ingrese el Título",
          titulo_en: "Ingrese el Título Ingles",
          url_seo: "Ingrese url",
          f_publicacion: "Ingrese su mensaje",
          descrip_superior: "Ingrese la Descripción Corta",
          descrip_superior_en: "Ingrese la Descripción Corta en Ingles",
          descrip_inferior: "Ingrese la Descripción",
          descrip_inferior_en: "Ingrese la Descripción en Ingles"
        }
      });
    };
    scope.procesarForm = function(data) {
...
app.controller('listarSuscriptorCrtl', [
  '$scope', '$http', '$timeout', '$rootScope', '$cookieStore', '$location', 'AuthenticationService', function(scope, http, timeout, rootScope, cookieStore, location, AuthenticationService) {
    scope.form = [];
    scope.form = {};
    scope.datos = [];
    ...
    scope.listar = function(page, filtro) {
      ...
      url = './controller/suscriptores/listar.php';
      result = http.post(url, data);
      result.success(function(response) {
        var i, total;
        if (response !== "false") {
          scope.datos = response['suscriptores'];
          i = 0;
          total = response['paginado'].total_paginas;
          while (i < total) {
            scope.range.push(i);
