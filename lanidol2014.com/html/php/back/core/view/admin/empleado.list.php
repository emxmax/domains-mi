...
?>
                ...
                <table width="500" class="tblList" cellpadding="0" cellspacing="0">
                      <tr> 
                        ...
                        <th width="120"><b><?php echo showHeader('nombres','Nombres')?></b></th>
                        <th width="80"><b><?php echo showHeader('apellido1','Apellido P.')?></b></th>
                        <th width="80"><b><?php echo showHeader('apellido2','Apellido M.')?></b></th>
