...
<td valign="top">
        <table class="tblForm" width="600">
              <tr>
                ...
                <td><input name="title" type="text" class="text" id="title" value="<?php echo htmlentities($oItem->title); ?>" size="70" maxlength="255"></td>
              </tr>
            <?php
            if($oScheme!=null){
                ...
                if(file_exists($file_template)){
                    ...
                    //place holder banner direction
                    if(in_array($oScheme->schemeID, array(11, 13, 16, 22, 25, 27, 28, 29, 38, 39, 78, 82))){
                        echo '
                          <tr>
                            <td>Ubicaci&oacute;n de Banners</td>
                            <td><label><input name="parameter[banner_align]" type="radio" id="banner_align" value="1" '. ($oItem->parameter['banner_align']=='1'? 'checked': '') .'>Horizontal</label>
<label><input name="parameter[banner_align]" type="radio" id="banner_align" value="2" '. ($oItem->parameter['banner_align']=='2'? 'checked': '') .'>Vertical</label></td>
                          </tr>
                        ';
                    }
                }
