...
case 3:
    ...
    $ctlEdit="<input type='text' name='terminoName' id='terminoName' size='25' value='".(($oItem->nullValue==1)? $oItem->terminoName: '')."' />
    <script type=\"text/javascript\">$(document).ready(function() { FileManager('terminoName', {title: 'Seleccione una imagen', basePath: '".$path."', fileExt: '*.jpg;*.gif;*.png'} );});</script>";
    break;
}
...
<table class="tblForm" width="500">
    ...
    <tr> 
      <td colspan="2">
          ...
          <input type="button" class="admButton" name="btnCancel" value="cancelar" onClick="javascript:Back();">
      </td>
    </tr>
</table>
