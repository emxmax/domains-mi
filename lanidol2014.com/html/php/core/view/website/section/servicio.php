...
?>
<style type="text/css">
@import url('<?php echo $URL_BASE;?>css/anaranjado.css');
</style>
...
?>
                    ...
                    <span class="a-anaranjado"><a href="<?php echo SEO::get_URLRedirect($oSectionLang->parameter['enlaceID'], $oSectionLang->langID, $oSectionLang->minisiteID); ?>">VER M&Aacute;S</a></span>
              </div>
...
<?php }?>
<?php
$lModulo=CmsContentLang::getWebList_Scheme(58, $oSectionLang->langID, $oSectionLang->minisiteID);
				...
				?>
                    <div>
                        ...
                        <div class="modulos-par-container">  
                            ...
                            <span class="a-anaranjado"><a href="<?php echo $oLink->url; ?>" target="<?php echo $oLink->target; ?>">VER M&Aacute;S</a></span>
                        </div>
                    </div>
				<?php } ?>
              </div>
