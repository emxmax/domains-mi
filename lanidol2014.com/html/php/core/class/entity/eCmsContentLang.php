<?php
    ...
    class eCmsContentLang{
        ...
        var $totalLikes;        //from fcms_childContentLikes
        ...
        public function append($parentContentID, $schemeID, $contentName, $position, $sectionID, $templateID, $childScheme=null, $childContentLang=null)
        {
            //Aditional parameters to load list
