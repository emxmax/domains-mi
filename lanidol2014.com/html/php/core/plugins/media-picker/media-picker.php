...
$groupID	= OWASP::RequestInt('gID');
$fileName	= OWASP::RequestString('fName');
$basePath	= OWASP::RequestString('path');
$mediaID	= OWASP::RequestInt('mID');
...
function ShowFiles($basePath){
    ...
    if(!is_dir($targetPath) && !mkdir($targetPath, 0777, true)){
        echo "<p>No se puede crear el directorio $basePath.</p>";
        return;
    }
