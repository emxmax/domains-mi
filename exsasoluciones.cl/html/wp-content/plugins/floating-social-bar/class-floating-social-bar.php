...
class floating_social_bar {
    ...
    public function do_social_bar_output( $services, $atts = array(), $manual = false ) {
        ...
        $css     = '
            #fsb-social-bar { width: 100%; border-bottom: 1px solid #dbdbdb; border-top: 1px solid #dbdbdb; padding: 10px 0; margin: 0px 0 20px 0; float: left; background: #e5e5e5; position: relative; clear: both; }
            ...
            #fsb-social-bar .socialite { display: block; position: relative; background: url(' . plugins_url( 'images/fsb-sprite2.png', __FILE__ ) . ') no-repeat scroll 0 0; }
