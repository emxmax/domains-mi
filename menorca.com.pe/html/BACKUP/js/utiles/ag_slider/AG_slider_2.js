$.fn.AG_slider = function(opciones) {
	...
	this.mostrarResumen=function(dato){
		if(opc.mensajeModo1==true){
			$(opc.elementoMensajeModo1).hide();
			$(opc.elementoMensajeModo1).eq(dato).slideDown(1000);
		}
	}
...
*/
	...
	function moverSlide() {
		...
		if(opc.mensajeModo2==true){
			$(opc.elementoMensajeModo2).hide();
			$(opc.elementoMensajeModo2).eq(contador).slideDown(1000);
		}
