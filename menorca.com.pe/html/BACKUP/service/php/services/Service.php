...
//CLASES GENERALES
    ...
    public function enviarCorreo($data)
    {
        ...
        $headers .= "From: Contacto - Menorca Lotes <$lpd_mail>\r\n";
                    ...
                    <body style=" font-family: "courier";">
                        <div id="container" style="margin: 0 10%; width: 80%;">
                            <div id="imagen" style="text-align: center;">
                                <img src="http://menorca.com.pe/imagenes/logo_empresa.png" width="200px">
                            </div>
                            <div id="contenido" style="background: #ffffff; border-radius: 5px; color: #ffffff; padding: 30px;">
                                <h2 style="color:#1c953f;">Nuevo Mensaje recibido</h2>
                                <table width="100%" border="0" cellspacing="5" cellpadding="1">
                                    <tr>
                                        <td height="40" align="center" bgcolor="#1c953f" class="etiqueta">Nombre</td>
                                        <td colspan="2" class="valor" style="color:black;">'.strtoupper($nombre).'</td>
                                    </tr>
                                    <tr>
                                        <td height="40" align="center" bgcolor="#1c953f" class="etiqueta">DNI</td>
                                        <td colspan="2" class="valor" style="color:black;">'.strtoupper($dni).'</td>
                                    </tr>
                                    <tr>
                                        <td height="40" align="center" bgcolor="#1c953f" class="etiqueta">Telefono</td>
                                        <td colspan="2" class="valor" style="color:black;">'.$telefono.'</td>
                                    </tr>
                                    <tr>
                                        <td height="40" align="center" bgcolor="#1c953f" class="etiqueta">Correo</td>
                                        <td colspan="2" class="valor" style="color:black;">'.$email.'</td>
                                    </tr>
                                    <tr>
                                        <td height="40" align="center" bgcolor="#1c953f" class="etiqueta">Proyecto</td>
                                        <td colspan="2" class="valor" style="color:black;">'.$proyecto.'</td>
                                    </tr>
                                    <tr>
                                        <td height="40" align="center" bgcolor="#1c953f" class="etiqueta">Consulta</td>
                                        <td colspan="2" class="valor" style="color:black;">'.$consulta.'</td>
                                    </tr>
                                </table>
                            </div>
                            <div id="footer" style="background: #1c953f; color: #ffffff; text-align: center;">
                                <p>MENORCA LOTES</p>
                            </div>
                        </div>
                    </body>
                    </html>';
                    //atencion_al_cliente@norvial.com.pe
       // $resultado=mail('sboza@menorca.com.pe,acarozzi@menorca.com.pe,lescobedo@menorca.com.pe,acanales@menorca.com.pe',"Contacto - Menorca",$message,$headers);
                    //$resultado=mail('ventasrebote@menorca.com.pe,acarozzi@menorca.com.pe,nurrunaga@menorca.com.pe,lescobedo@menorca.com.pe,lmanrique@menorca.com.pe',"Contacto - Menorca Lotes",$message,$headers);
                    //$resultado=mail('ventasrebote@menorca.com.pe,acarozzi@menorca.com.pe,nurrunaga@menorca.com.pe,lescobedo@menorca.com.pe,lmanrique@menorca.com.pe',"Contacto - Menorca Lotes",$message,$headers);  

                    $resultado=mail('ventasrebote@menorca.com.pe,acarozzi@menorca.com.pe,nurrunaga@menorca.com.pe,lmanrique@menorca.com.pe',"Contacto - Menorca Lotes",$message,$headers);  
 
                   //$resultado=mail('jfalcon910@gmail.com',"Contacto - Menorca",$message,$headers);
        if($resultado){
            return 1;
        }else{
            return 0;
