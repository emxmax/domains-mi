...
$estado = "inicio";
	...
	if($_POST){
        ...
        //$mail->SetFrom(mail_postmaster,"Portal - ".from_name);
        $mail->Timeout=30;
        $mail->AddAddress(mail_to,"Portal - ".from_name);
        $mail->AddBCC(mail_to1,"Administrador");
        $mail->AddBCC(mail_to2,"Administrador");
        $mail->AddBCC(mail_to3,"Administrador");
        /*$mail->AddAddress(mail_postmaster,"Portal - ".from_name);
        $mail->AddBCC("alexico22@hotmail.com", "Administrador 1");
        $mail->AddBCC("alexisgq@yahoo.com", "Administrador 2");*/
        $mail->AddBCC(mail_postmaster,"Administrador");
