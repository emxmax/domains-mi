...
$file_root = 'repositorio'; 		//where to store files, must be created and writable
...
require('bin/fm/class.upload.php');

//lang
$lng = array();
require('bin/fm/lang/lang_' . strtolower($lang) . '.php');
...
function print_files($c = '.') {
  ...
  echo('<table id="file-list" cellspacing="0">');
  $d = opendir($c);
  $i = 0;
  while($f = readdir($d)) {
    if(strpos($f, '.') === 0) continue;
    ...
    if(!is_dir($ff)) {
	    ...
	    if($imageinfo && $imageinfo[2] > 0 && $imageinfo[2]< 4) {
	    	...
	    	if($imageinfo[0] > $thmb_size or $imageinfo[1] > $thmb_size) {
				...
				echo '<td class="prev_files"><a class="file thumbnail ' . $imagetype . '" href="#" onclick="submit_url(\'' . $root_path . '/' . $ff . '\');">' . $f . '<span><img' . $resize . ' src="' . $root_path . '/' . $ff . '" /></span></a>'; echo '</td>';
			//known file types
			...
			echo '<td class="prev_size">' . byte_convert(filesize($ff)) . '</td>';
...
<head>
  ...
  <link rel="stylesheet" href="/bin/fm/style.css" type="text/css" />
  <?php if ($mode != 'standalone') {  ?>
  <link rel="stylesheet" href="<?php echo $root_path; ?>/bin/tiny_mce/themes/advanced/skins/default/dialog.css" type="text/css" />
  <script type="text/javascript" src="<?php echo $root_path; ?>/bin/tiny_mce/tiny_mce_popup.js"></script>
  <?php } ?>
  <script type="text/javascript">
		...
		function ahah(url, target, callback) {
			document.getElementById(target).innerHTML = '<img src="bin/fm/loading.gif" alt="" /> <?php echo $lng['loading']; ?>';
		...
		function submit_url(URL) {
          ...
          switch (type) {
			case "image":
				...
				var clase=URL.substring(URL.length-3);
				clase=clase.toLowerCase();
				
				if(clase=='jpg' || clase=='gif' || clase=='png' || clase=='flv' || clase=='swf' || clase=='mp3' || clase=='mp4'){
		
				var titulo=<?php echo "'".$_GET['titulo']."'" ?>;
		
				if(<?php echo "'".$_GET['estado']."'"; ?>=='true') window.opener.$('#'+<?php echo "'".$_GET['field']."'"; ?>).append('<div class="archivo"><div class="nombre"><span class="eliminarArchivo" title="Eliminar"><img src="images/adm/eliminar.gif" alt="Eliminar" /></span><span><strong>Ruta: </strong></span><span class="datoArchivo">'+URL+'</span><span class="tituloArchivo" title="Agregar '+titulo+'"><img src="images/adm/titulo.gif" alt="Agregar '+titulo+'" /></span><span class="enlaceArchivo"><a href="'+URL+'" title="Ver"><img src="images/adm/busqueda.gif" alt="Busqueda" /></a></span><span class="enlaceArrastre" title="Mover"><img src="images/adm/icono_drag.gif" alt="Mover" /></span></div><div class="extras"><div class="titulo"><span><strong>'+titulo+': </strong></span><input type="text" name="" id="" value="" class="box5 fondo1 formato2" /></div></div></div>');
				if(<?php echo "'".$_GET['estado']."'"; ?>=='false') window.opener.$('#'+<?php echo "'".$_GET['field']."'"; ?>).append('<div class="archivo"><div class="nombre"><span class="eliminarArchivo" title="Eliminar"><img src="images/adm/eliminar.gif" alt="Eliminar" /></span><span><strong>Ruta: </strong></span><span class="datoArchivo">'+URL+'</span><span class="enlaceArchivo"><a href="'+URL+'" title="Ver"><img src="images/adm/busqueda.gif" alt="Busqueda" /></a></span></div></div>');
				if(<?php echo "'".$_GET['estado']."'"; ?>=='extra') window.opener.$('#'+<?php echo "'".$_GET['field']."'"; ?>).append('<div class="archivo"><div class="nombre"><span class="eliminarArchivo" title="Eliminar"><img src="images/adm/eliminar.gif" alt="Eliminar" /></span><span><strong>Ruta: </strong></span><span class="datoArchivo">'+URL+'</span><span class="tituloArchivo" title="Agregar '+titulo+'"><img src="images/adm/titulo.gif" alt="Agregar '+titulo+'" /></span><span class="enlaceArchivo"><a href="'+URL+'" title="Ver"><img src="images/adm/busqueda.gif" alt="Busqueda" /></a></span><span class="enlaceArrastre" title="Mover"><img src="images/adm/icono_drag.gif" alt="Mover" /></span></div><div class="extras"><div class="dimenciones"><span><strong>Ancho: </strong></span><input type="text" name="" id="" value="" class="box6 fondo1 formato2" /><span><strong>Alto: </strong></span><input type="text" name="" id="" value="" class="box6 fondo1 formato2" /></div><div class="titulo"><span><strong>'+titulo+': </strong></span><input type="text" name="" id="" value="" class="box5 fondo1 formato2" /></div></div></div>');
				if(<?php echo "'".$_GET['estado']."'"; ?>=='plus') window.opener.$('#'+<?php echo "'".$_GET['field']."'"; ?>).append('<div class="archivo"><div class="nombre"><span class="eliminarArchivo" title="Eliminar"><img src="images/adm/eliminar.gif" alt="Eliminar" /></span><span><strong>Ruta: </strong></span><span class="datoArchivo">'+URL+'</span><span class="tituloArchivo" title="Agregar '+titulo+'"><img src="images/adm/titulo.gif" alt="Agregar '+titulo+'" /></span><span class="enlaceArchivo"><a href="'+URL+'" title="Ver"><img src="images/adm/busqueda.gif" alt="Busqueda" /></a></span><span class="enlaceArrastre" title="Mover"><img src="images/adm/icono_drag.gif" alt="Mover" /></span></div><div class="extras"><div class="titulo"><span><strong>'+titulo+': </strong></span><input type="text" name="" id="" value="" class="box5 fondo1 formato2" /></div></div></div>');
				//if(<?php echo "'".$_GET['estado']."'"; ?>=='galeria') window.opener.$('#'+<?php echo "'".$_GET['field']."'"; ?>).append('<div class="archivo"><div class="nombre"><span class="ADM_eliminar_archivo" title="Eliminar"><img src="images/adm/eliminar.gif" alt="Eliminar" /></span><span><strong>Ruta: </strong></span><span class="ADM_dato_archivo">'+URL+'</span><span class="ADM_titulo_archivo" title="Agregar '+titulo+'"><img src="images/adm/titulo.gif" alt="Agregar '+titulo+'" /></span><span class="ADM_enlace_archivo"><a href="'+URL+'" title="Ver"><img src="images/adm/busqueda.gif" alt="Busqueda" /></a></span></div><div class="extras"><div class="dimenciones"><span><strong>Ancho: </strong></span><input type="text" name="" id="" value="" class="ADM_FRM_boxDato9" /><span><strong>Alto: </strong></span><input type="text" name="" id="" value="" class="ADM_FRM_boxDato9" /></div><div class="titulo"><span><strong>'+titulo+': </strong></span><input type="text" name="" id="" value="" class="ADM_FRM_boxDato7" /></div></div></div>');
				
				if(<?php echo "'".$_GET['estado']."'"; ?>=='principal') window.opener.$('#'+<?php echo "'".$_GET['field']."'"; ?>).append('<div class="archivo"><div class="nombre"><span class="eliminarArchivo" title="Eliminar"><img src="images/adm/eliminar.gif" alt="Eliminar" /></span><span><strong>Ruta: </strong></span><span class="datoArchivo">'+URL+'</span><span class="tituloArchivo" title="Agregar '+titulo+'"><img src="images/adm/titulo.gif" alt="Agregar '+titulo+'" /></span><span class="enlaceArchivo"><a href="'+URL+'" title="Ver"><img src="images/adm/busqueda.gif" alt="Busqueda" /></a></span><span class="enlaceArrastre" title="Mover"><img src="images/adm/icono_drag.gif" alt="Mover" /></span></div><div class="extras"><div class="titulo"><span class="tipo1"><strong>Mensaje: </strong></span><textarea name="" class="area2 fondo1 formato2"></textarea></div><div class="titulo"><span><strong>URL: </strong></span><input type="text" name="" id="" value="" class="box8 fondo1 formato2" /></div></div></div>');
				if(<?php echo "'".$_GET['estado']."'"; ?>=='secundario') window.opener.$('#'+<?php echo "'".$_GET['field']."'"; ?>).append('<div class="archivo"><div class="nombre"><span class="eliminarArchivo" title="Eliminar"><img src="images/adm/eliminar.gif" alt="Eliminar" /></span><span><strong>Ruta: </strong></span><span class="datoArchivo">'+URL+'</span><span class="tituloArchivo" title="Agregar '+titulo+'"><img src="images/adm/titulo.gif" alt="Agregar '+titulo+'" /></span><span class="enlaceArchivo"><a href="'+URL+'" title="Ver"><img src="images/adm/busqueda.gif" alt="Busqueda" /></a></span><span class="enlaceArrastre" title="Mover"><img src="images/adm/icono_drag.gif" alt="Mover" /></span></div><div class="extras"><div class="dimenciones"><span><strong>Ancho: </strong></span><input type="text" name="" id="" value="" class="box9 fondo1 formato2" /><span><strong>Alto: </strong></span><input type="text" name="" id="" value="" class="box9 fondo1 formato2" /></div><div class="titulo"><span class="tipo1"><strong>Mensaje: </strong></span><textarea name="" class="area2 fondo1 formato2"></textarea></div><div class="titulo"><span><strong>URL: </strong></span><input type="text" name="" id="" value="" class="box8 fondo1 formato2" /></div></div></div>');
				if(<?php echo "'".$_GET['estado']."'"; ?>=='complemento') window.opener.$('#'+<?php echo "'".$_GET['field']."'"; ?>).append('<div class="archivo"><div class="nombre"><span class="eliminarArchivo" title="Eliminar"><img src="images/adm/eliminar.gif" alt="Eliminar" /></span><span><strong>Ruta: </strong></span><span class="datoArchivo">'+URL+'</span><span class="tituloArchivo" title="Agregar '+titulo+'"><img src="images/adm/titulo.gif" alt="Agregar '+titulo+'" /></span><span class="enlaceArchivo"><a href="'+URL+'" title="Ver"><img src="images/adm/busqueda.gif" alt="Busqueda" /></a></span><span class="enlaceArrastre" title="Mover"><img src="images/adm/icono_drag.gif" alt="Mover" /></span></div><div class="extras"><div class="dimenciones"><span><strong>Título: </strong></span><input type="text" name="" id="" value="" class="box10 fondo1 formato2" /></div><div class="titulo"><span class="tipo1"><strong>Mensaje: </strong></span><textarea name="" class="area2 fondo1 formato2"></textarea></div><div class="titulo"><span><strong>URL: </strong></span><input type="text" name="" id="" value="" class="box8 fondo1 formato2" /></div></div></div>');
				
				
				if(<?php echo "'".$_GET['estado']."'"; ?>=='galeria') window.opener.$('#'+<?php echo "'".$_GET['field']."'"; ?>).append('<div class="archivo"><div class="nombre"><span class="ADM_eliminar_archivo" title="Eliminar"><img src="images/adm/eliminar.gif" alt="Eliminar" /></span><span><strong>Ruta: </strong></span><span class="datoArchivo">'+URL+'</span><span class="tituloArchivo" title="Agregar '+titulo+'"><img src="images/adm/titulo.gif" alt="Agregar '+titulo+'" /></span><span class="enlaceArchivo"><a href="'+URL+'" title="Ver"><img src="images/adm/busqueda.gif" alt="Busqueda" /></a></span><span class="enlaceArrastre" title="Mover"><img src="images/adm/icono_drag.gif" alt="Mover" /></span></div><div class="extras"><div class="titulo"><span><strong>'+titulo+': </strong></span><textarea name="" class="box7 fondo1 formato2"></textarea></div></div></div>');
																																	
				}else{
				
				window.opener.$('#'+<?php echo "'".$_GET['field']."'"; ?>).append('<div class="archivo"><div class="nombre"><span class="eliminarArchivo" title="Eliminar"><img src="images/adm/eliminar.gif" alt="Eliminar" /></span><span><strong>Ruta: </strong></span><span class="datoArchivo">'+URL+'</span></div></div>'); 
				
				}
		   
				break;
			case "video":
				//window.opener.document.images[img_temp].src = URL;
				break;
			case "flash":
				//window.opener.document.images[img_temp].src = URL;
				
				window.opener.$('#'+<?php echo "'".$_GET['field']."'"; ?>).append('<div class="archivo"><div class="nombre"><span class="eliminarArchivo" title="Eliminar"><img src="images/adm/eliminar.gif" alt="Eliminar" /></span><span><strong>Ruta: </strong></span><span class="datoArchivo">'+URL+'</span><span class="enlaceArchivo"><a href="'+URL+'" title="Ver"><img src="images/adm/busqueda.gif" alt="Busqueda" /></a></span><span class="enlaceArrastre" title="Mover"><img src="images/adm/icono_drag.gif" alt="Mover" /></span></div></div>');
		...
		?>
			...
			var win = tinyMCEPopup.getWindowArg("window");
			      ...
			      switch (type) {
			        case "image":
			            break;
			        case "media":
			            if(URL.indexOf('.flv', 0) != -1) URL="/bin/player/flvplayer.swf?file="+URL+"&usefullscreen=false&autostart=true";  
			            break;
			        case "file":
			            break;
			      }
			...
			//if (win.ImageDialog.showPreviewImage) win.ImageDialog.showPreviewImage(URL);
                // are we an image browser?  solucion
