        ...
        <script src="https://use.fontawesome.com/ac37c3b347.js"></script>
                    ...
                    <div class="col-lg-2 col-sm-2 align col-xs-4 col-sm-push-2">
                      <div class="row">
                        ...
                        <ol>
                          ...
                          <li class="regalos-novedosos"><a href="<?php echo $url;?>categorias/regalos-novedosos"><img src="<?php echo $url;?>img/regalos-novedosos.png" alt=""> Regalos novedosos</a></li>
                          <li><a href="https://www.redgalar.com/socios/veggiemania"><img src="<?php echo $url;?>img/logo-rojo.png" alt=""> Comida vegana</a></li>
                          ...
                          <li><a href="https://www.redgalar.com/socios/fitgo"><img src="<?php echo $url;?>img/productos-ecologicos.png" alt=""> Comidas saludables</a></li>
                          <li><a href="#"><img src="<?php echo $url;?>img/articulos-deportivos.png" alt=""> Parrillas</a></li>
                        ...
                        <?php 
                          if(isset($_SESSION['email'])){
                              ...
                              if($user_provider=="facebook"){
                                ...
                                $user_foto_header = $url."fotos/".$user_fo;
                              }
                          ...
                          ?>
                            ...
                            <li>                              
                              <a href="<?php echo $url.'perfil' ?>">
                                ...
                                ?>        
                                <img src='<?php echo $user_foto_header ?>' class='foto-nav'>                        
                                <span class="hidden-xs">Mi Perfil</span>
                              </a>                              
                            </li>

                            <li id="submenu">
                              <a href="https://www.redgalar.com/logout.php">
                                <!-- <img src="<?php echo $user_foto_header ?>" alt="" class='foto-nav'> -->
                                <span class="hidden-xs">
                                  <i class="fa fa-sign-out fa-2x" aria-hidden="true" style="display: inline; color:#B5B5B5"></i>Salir
                                </span>
                              </a>
                              <ul class="opciones">
                                <li>
        ...
        <div class="row">     
          <div class="col-xs-12">
            <ul>
              ...
              <li><a href="https://www.redgalar.com/vende-con-nosotros">Vende con nosotros</a></li>
