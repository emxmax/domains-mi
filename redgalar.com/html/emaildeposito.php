<?php
  ...
  $bodyMsj = '<body>
		...
		<div class="order" style="background: #F0F1F5;margin-top: 10px;border-radius: 4px;">
			<div class="inner-detallado" style="padding-left: 28px; padding-bottom: 10px;">
				<div style="width:80%; display:inline-block;vertical-align: top;">
					<h4 style="color: #D2333D;font: 13px arial;font-weight: 900;margin-bottom:0px">Recuerda que...</h4>
					<p style="font: 11px arial;color: #666666;">Para que el equipo de Redgalar realice tu pedido, debes terminar con el proceso de pago siguiendo estos sencillos pasos:</p>
				</div>
			</div>
			<div>
				<img src="https://www.redgalar.com/img/email/deposito.jpg">
			</div>
	...
	$para = "erick@redgalar.com,$user_email";
