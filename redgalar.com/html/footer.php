			...
			<div class="col-lg-12">
				...
				<div class="col-lg-3 col-md-3 col-sm-3 mt">
					...
					<ul>
						...
						<li><a href="https://www.redgalar.com/socios/veggiemania">Comida vegana</a></li>
						<li><a href="<?php echo $url;?>categorias/desayunos">Desayunos personalizados</a></li> 
						<li><a href="<?php echo $url;?>categorias/comida-saludables">Comida saludable</a></li>
						<li><a href="<?php echo $url;?>categorias/antojitos">Antojitos</a></li>
						<!--
						<?php 
				...
				<div class="col-lg-3 col-md-3 col-sm-3 mt">
					...
					<br>
					<a href="https://www.redgalar.com/admin/" class="footer-socio">¿Eres socio?</a>					
				</div>
				<div class="col-lg-2 col-lg-offset-1 col-md-3 col-sm-3 mt">
					<h3>SÍGUENOS</h3>
					<ol>
						<li><a href="https://www.facebook.com/redgalar" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						<li><a href="https://www.instagram.com/redgalar/" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
