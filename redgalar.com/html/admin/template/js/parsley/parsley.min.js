...
!function(d){var h=function(a){this.messages={defaultMessage:"This value seems to be invalid.",type:{email:"This value should be a valid email.",url:"This value should be a valid url.",urlstrict:"This value should be a valid url.",number:"Este valor debe ser un número válido.",digits:"This value should be digits.",dateIso:"Ingrese fecha (dd/mm/YYYY).",alphanum:"This value should be alphanumeric.",phone:"Este valor debe ser un número de teléfono válido."},notnull:"This value should not be null.",
notblank:"This value should not be blank.",required:"campo requerido.",regexp:"This value seems to be invalid.",min:"This value should be greater than or equal to %s.",max:"This value should be lower than or equal to %s.",range:"This value should be between %s and %s.",minlength:"Este valor es demasiado corto. Debe tener %s caracteres o más.",maxlength:"This value is too long. It should have %s characters or less.",rangelength:"Esta longitud valor no es válido. Debe estar entre %s y %s caracteres.",
