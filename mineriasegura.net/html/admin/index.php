...
if(isset($_SESSION['Msestado'])){
	if ($_SESSION['Msestado'] == 1) { 
		$estado=$_SESSION['Msestado'];
	    $nombre=$_SESSION['Msnombre'];
	    $idUsuario=$_SESSION['MsidUsuario'];
		$usuario=$_SESSION['Msusuario'];
        $clave=$_SESSION['Msclave'];
	}else{
		$estado=0;
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" id="seccionPaginas">
                    ...
                    -->
                    <li class="item-li item-posts"><a href="?sec=posts">Posts</a></li>
                    <li class="item-li item-menu"><a href="?sec=menu">Menú</a></li>
                </ul>
            </div>
        </nav>
