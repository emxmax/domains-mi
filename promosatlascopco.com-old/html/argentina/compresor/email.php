...
define("DB_DATABASE","xxqitbn_db77722_atlasargentina");
// define("DB_SERVER","localhost");
// define("DB_USER","root");
// define("DB_PASSWORD","");
...
$sql = "INSERT INTO contacto (nombre, apellido, telefono, email, empresa,provincia, localidad)
				VALUES('$nombre','$apellido','$telefono','$email', '$empresa','$provincia','$localidad')";
if (mysql_query($sql, $cn)) {
		...
		$the_subject = "Compresor X28 Febrero 2018 #".$iddd;
		...
		$phpmailer->AddCC("enrique.mendiondo@ar.atlascopco.com", "");
		$phpmailer->AddCC("info.construccion@pe.atlascopco.com", "");
		$phpmailer->Subject = $the_subject; 
		$phpmailer->Body .="<h1 style='color: black;'>Mensaje Landing - Argentina</h1>";
		$phpmailer->Body .= "<p>Recibiste un  nuevo contacto:</p>";
		$phpmailer->Body .= "<p>Nombre :".$nombre." </p>";
		$phpmailer->Body .= "<p>Apellido :".$apellido." </p>";
