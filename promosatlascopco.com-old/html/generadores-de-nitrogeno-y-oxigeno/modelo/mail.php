...
class Mailto{
	...
	private $Username	    = 'mc@mediaimpact.pe';                 // SMTP username;
	private $Password	    = 'Mediaimpact2016$';                      // SMTP password
	private $Port	    	= 26;                                    // TCP port to connect to
	private $From	    	= 'mc@mediaimpact.pe';
	private $nameFrom	    = 'Atlas Copco';
	private $Subject	    = '';
	private $Body 			= '';
	private $AltBody		= 'Generadores de nitrógeno y oxígeno - Promos Atlas Copco';
	...
	function CuerpoContacto($arr=NULL){
		$this->Subject = 'Generadores de nitrógeno y oxígeno - Promos Atlas Copco';
		$this->Body = '<table>';
