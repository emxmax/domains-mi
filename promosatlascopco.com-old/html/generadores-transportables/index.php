...
<html lang="es">
  <head>
    <title>Generadores Transportables | Atlas Copco</title>
    <meta charset="utf-8">
            ...
            <div class="row cuerpo-landing">
              <div class="col-xs-12">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  <div class="row">
                    <div class="consulta">
                      Complete sus datos y un especialista le enviará información detallada de nuestra gama de grupos electrógenos.
                    </div>
                    <form id="formulario">
                      <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  <div class="carro">
                    <div class="foto-carro">
                      <div>
                        ¿Sabía que nuestra gama de grupos electrógenos QAS ofrece una capacidad desde 16kVA(13kW) hasta 688kVA (550kW) en potencia Prime?
                        Encuentre la transportabilidad, alta potencia y confiabilidad  en la QAS 500.
                        <br>
                      ...
                      <div>
                        ...
                        <span>Incluye Kit de Mantenimiento</span>
                      </div>
                    </div>
                    <div class="rectangle">
                      ...
                      <ul>
                        <li>
                            <a href="http://www.atlascopco.com.co/es-co/construction-equipment/products/Mobile-air-compressors" target="_blank">Compresores</a> 
                        </li>
                        <li>
                            <a href="http://www.atlascopco.com.co/es-co/construction-equipment/products/handheld" target="_blank">Equipos de Construcción</a> 
                        </li>
                        <li>
                            <a href="http://www.atlascopco.com.co/es-co/construction-equipment/service" target="_blank">Servicio Técnico y Repuestos</a>
                        </li>
                        <li>
                            <a href="http://www.atlascopco.com.co/es-co/construction-equipment/products/light-towers" target="_blank">Torres de iluminación</a> 
                        </li>
                        <li>
                            <a href="http://www.atlascopco.com.co/es-co/Rental" target="_blank">Alquiler de equipos</a> 
                        </li>
                      </ul>
                    </div>
                  </div>
