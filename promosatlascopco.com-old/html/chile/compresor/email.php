...
define("DB_DATABASE","db77722_atlaschile");
...
if (mysql_query($sql, $cn)) {
		...
		$the_subject = "Compresor portátil XAS 88 + Martillo RTEX Febrero 2018 #".$iddd;
		...
		$phpmailer->AddCC("francisco.caballero@cl.atlascopco.com", "");
		$phpmailer->AddCC("rodrigo.aguilera@cl.atlascopco.com", "");
		$phpmailer->AddCC("info.construccion@pe.atlascopco.com", "");
		$phpmailer->Subject = $the_subject; 
		$phpmailer->Body .="<h1 style='color: black;'>Mensaje Landing - Chile</h1>";
