     ...
     <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Documentos Importantes <small>Agregar</small></h2>
          ...
          <form action='add.php' method='post' enctype="multipart/form-data">
			  ...
			  <div class="form-group">
				...
				<select class="form-control" name="nivel_id">
					<?php
				  for($n = 0; $n < $nNivelAdmin; $n++){
					$nivel_id = mysql_result($rsNivelAdmin,$n,"nivel_id");
					$nivel_name = mysql_result($rsNivelAdmin,$n,"nivel_name");
				  ?>
