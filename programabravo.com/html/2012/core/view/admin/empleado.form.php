...
<table class="tblForm" width="500">
  ...
  <tr>
    ...
    <td><input name="dni" type="text" class="text" id="dni" value="<?php echo $oItem->dni; ?>" size="45" maxlength="10"></td>
  </tr>
  <tr>
    <td><strong>Clave</strong></td>
    <td><input name="clave" type="text" class="text" id="clave" value="<?php echo $oItem->clave; ?>" size="15" maxlength="10"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input name="fechaNacimiento" type="text" class="text" id="fechaNacimiento" value="<?php echo $oItem->fechaNacimiento; ?>" size="15" maxlength="10">(a&ntilde;o-mes-d&iacute;a)</td>
  </tr>
  <tr>
    <td>Estado</td>
    <td>
