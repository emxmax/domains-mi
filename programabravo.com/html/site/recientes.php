...
$url_iframe = ($criterio!=NULL)? 'mensajes.html?filtro='.$filtro.'&criterio='.$criterio: 'mensajes.html?filtro=3#'.$postitID;
?>
            ...
            <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="158" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                      <td><form id="search2" name="search2" method="post" target="results" action="mensajes.html">
                      <table width="120" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="180"><label for="txt2"></label>
                          <input name="criterio" type="text" id="txt2" style="width:90px;" class="defaultInputValue" title="Ingrésalo aquí" /></td>
                          <td><a href="#" id="lnk2"><img src="images/space.png" width="30" height="20" /></a></td>
                      </tr>
                      </table>
                      </form>
                    </td>
                  ...
                  <tr>
                    <td valign="top"><img src="<?php echo $URL_BASE;?>images/space.png" width="110" height="65" usemap="#Map3Map" border="0" />
                      <map name="Map3Map" id="Map3Map">
                        <area shape="rect" coords="3,30,104,56" href="reconoce.html" />
                      </map></td>
                  </tr>
                </table></td>
