        ...
        $.ajax({
          ...
          success: function(data){
            if(parseInt(data)>voto){
                ...
                parent.ShowAlert("Excelente!, gracias por valorar esta nota.");
            }
            else
                parent.ShowAlert("Ya has valorado esta nota antes, gracias.");
          }
        });
    });
});
...
::-webkit-scrollbar-thumb {
    background: rgba(91,196,204,1); 
    -webkit-box-shadow: inset 0 0 1px rgba(91,196,204,1); 
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><span class="arialazulbold"><?php echo htmlentities($oItem->destino);?> / <?php echo htmlentities($oItem->mundoDestino);?></span><br /></td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
      <td><a name="<?php echo $oItem->postitID;?>"></a><span class="arialazulbold">De: <?php echo htmlentities($oItem->origen);?> / <?php echo htmlentities($oItem->mundoOrigen);?></span> <?php echo $oItem->mensaje;?> <br />
      <span class="arialazulbold">Para: <?php echo htmlentities($oItem->destino);?> / <?php echo htmlentities($oItem->mundoDestino);?></span><br /></td>
  </tr>
  <tr>
