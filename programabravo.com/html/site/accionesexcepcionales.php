...
<table width="1022" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="1022" height="259" border="0" cellspacing="0" cellpadding="0" background="<?php echo $URL_BASE;?>images/parte06.png">
      <tr>
...
<img src="http://smallseotools.com/visitor-counter/counter.php?code=436c26abd464041efd354bc550f76482&style=0004&pad=9&type=ip&initCount=25328"title="Visitor Counter" Alt="Visitor Counter" border="0">
  ...
  <tr>
    <td><table width="1022" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top" background="<?php echo $URL_BASE;?>images/parte03b.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="146" valign="bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="470">&nbsp;</td>
                <td><a href="archivos/accionesexcepcionales.pdf" target="_blank"><img src="<?php echo $URL_BASE;?>images/space.png" width="100" height="80" border="0" /></a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="96">&nbsp;</td>
                <td><iframe width="475" height="196" src="archivos/accionesexcepcionales.pdf"></iframe></td>
              </tr>
            </table></td>
          </tr>
          <tr>
        ...
        <td width="431"><img src="<?php echo $URL_BASE;?>images/parte04b.png" width="431" height="536" usemap="#Map2" border="0" /></td>
      </tr>
    </table></td>
  </tr>
</table>
