...
<head>
<?php include '../core/include/website/header.php';?></head>
<body>
<table width="1022" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="1022" height="259" border="0" cellspacing="0" cellpadding="0" background="<?php echo $URL_BASE;?>images/parte05.png">
      <tr>
...
<img src="http://smallseotools.com/visitor-counter/counter.php?code=436c26abd464041efd354bc550f76482&style=0004&pad=9&type=ip&initCount=25328"title="Visitor Counter" Alt="Visitor Counter" border="0">
  ...
  <tr>
    <td><table width="1022" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top" background="<?php echo $URL_BASE;?>images/parte03c.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="125" valign="bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="470">&nbsp;</td>
                <td><a href="archivos/tiempodeservicio2014.pdf" target="_blank"><img src="<?php echo $URL_BASE;?>images/space.png" width="100" height="40" border="0" /></a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="102">&nbsp;</td>
                <td><iframe width="464" height="230" src="archivos/tiempodeservicio2014.pdf"></iframe></td>
              </tr>
            </table></td>
          </tr>
          <tr>
        ...
        <td width="431"><img src="<?php echo $URL_BASE;?>images/parte04c.png" width="431" height="536" usemap="#Map2" border="0" /></td>
      </tr>
    </table></td>
  </tr>
</table>
