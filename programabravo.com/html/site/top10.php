...
<table width="1022" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="1022" height="259" border="0" cellspacing="0" cellpadding="0" background="<?php echo $URL_BASE;?>images/parte09.png">
      <tr>
...
<img src="http://smallseotools.com/visitor-counter/counter.php?code=436c26abd464041efd354bc550f76482&style=0004&pad=9&type=ip&initCount=25328"title="Visitor Counter" Alt="Visitor Counter" border="0">
  ...
  <tr>
    <td><table width="1022" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top" background="<?php echo $URL_BASE;?>images/parte03.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="63">&nbsp;</td>
          </tr>
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="111">&nbsp;</td>
                <td width="247"><iframe width="216" height="292" frameborder="0" src="mensajes.html?filtro=2"></iframe></td>
                <td><iframe width="216" height="292" frameborder="0" src="mensajes.html?filtro=4"></iframe></td>
              </tr>
            </table></td>
          </tr>
          </table>
          <img src="<?php echo $URL_BASE;?>images/space.png" width="565" height="83" usemap="#Map3" border="0" />
        </td>
        <td width="431">
            <img src="<?php echo $URL_BASE;?>images/parte04.png" width="431" height="537" usemap="#Map2" border="0" />
        </td>
      </tr>
    </table></td>
  </tr>
