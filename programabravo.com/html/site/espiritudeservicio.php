...
<img src="http://smallseotools.com/visitor-counter/counter.php?code=436c26abd464041efd354bc550f76482&style=0004&pad=9&type=ip&initCount=25328"title="Visitor Counter" Alt="Visitor Counter" border="0">
  ...
  <tr>
    <td><table width="1022" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top" background="<?php echo $URL_BASE;?>images/parte03a.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="83">&nbsp;</td>
          </tr>
          <tr>
            <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="89">&nbsp;</td>
                <td><embed src="animaciones/Bravo5.swf" width="490" height="261"></embed></td>
              </tr>
            </table></td>
          </tr>
          <tr>
        ...
        <td width="431"><img src="<?php echo $URL_BASE;?>images/parte04a.png" width="431" height="537" usemap="#Map2" border="0" /></td>
      </tr>
    </table></td>
  </tr>
</table>
