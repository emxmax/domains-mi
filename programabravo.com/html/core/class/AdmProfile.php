...
class AdmProfile extends Database
{
	...
	public static function  getList($clientID){
		$query ="SELECT profileID, profileName, isDefault
		FROM adm_profile ";
		if($clientID>0) $query .="WHERE clientID='$clientID' OR profileID='2'";
	...
	public static function  AddNew($oAdmProfile){
		...
		$query = "INSERT INTO adm_profile(profileID, clientID, profileName, isDefault)
				VALUES('$oAdmProfile->profileID', '$oAdmProfile->clientID', '$oAdmProfile->profileName', '$oAdmProfile->isDefault')";
