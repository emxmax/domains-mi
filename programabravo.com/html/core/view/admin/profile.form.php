...
function Print_TreeModule($menuID, $profileID){
	...
	foreach($lModulo as $oModule){
		...
		foreach ($list as $obj) {
			echo "<li><input type=\"checkbox\" name=\"events[]\" id=\"ev_".$obj->eventID."\" value=\"".$obj->eventID."\"";
	...
	xform.submit();
                    ...
                    <table class="tblForm" width="500">
                      <tr> 
                        ...
                        <td width="400"><input name="profileName" type="text" class="text" id="profileName" value="<?php echo $oItem->profileName; ?>" size="30" maxlength="30"></td>
                      </tr>
                      <tr> 
