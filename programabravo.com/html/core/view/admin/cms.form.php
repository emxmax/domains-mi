...
$(document).ready(function(){
	...
	$("#btnSave").click(function(){
		...
		if($("#title").val() ==""){
			alert("Por favor, ingrese el campo [T\xedtulo]");
			$("#title").focus();
			return false;
		}
		if($("#staticURL").val() ==""){
			alert("Por favor, ingrese el campo [URL estática]");
...
<td valign="top">
        <table class="tblForm" width="600">
              <tr>
                ...
                <td><input name="title" type="text" class="text" id="title" value="<?php echo $oItem->title; ?>" size="70" maxlength="255"></td>
              </tr>
            <?php
            if($oScheme!=null){
