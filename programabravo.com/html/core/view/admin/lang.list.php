...
?>
                    <table width="500" class="tblList" cellpadding="0" cellspacing="0">
                      <tr> 
                        <th width="35">&nbsp;</th>
                        <th width="280"><?php echo $MODULE->getSortingHeader("langName", "Nombre");?></th>
	...
	?>
                      <tr>
                        <td nowrap="nowrap"><?php if($oItem->isDefault==0){ ?>
                        	<a href="<?php echo "javascript:Edit(".$oItem->langID.");"; ?>"><img title="Editar" src="../core/assets/admin/images/i_edit.gif" border="0" /></a>
                            <a href="<?php echo "javascript:Delete(".$oItem->langID.");"; ?>"><img title="Eliminar" src="../core/assets/admin/images/i_delete.gif" border="0" /></a>
                        <?php } else {?>
	                        <a href="<?php echo "javascript:View(".$oItem->langID.");"; ?>"><img title="Visualizar" src="../core/assets/admin/images/i_edit.gif" border="0" /></a>
                        <?php } ?>
						</td>
