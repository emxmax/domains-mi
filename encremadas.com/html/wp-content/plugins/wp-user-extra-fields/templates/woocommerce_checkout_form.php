...
<div id="wpuef-checkout-extra-fields">
	...
	<?php endif; ?>
		...
		<?php endif;
			...
			<select data-required="<?php if(!$required) echo 'no'; else echo 'yes';?>" class="wpuef_input_select wpuef_element" name="wpuef_options[<?php echo $extra_field->cid; ?>]" <?php if($read_only) echo 'disabled="disabled"'; if($extra_field->required) echo 'required="required"';?>>
		...
		<?php elseif($extra_field->field_type == "date"): 
			 ...
			 <input <?php if($read_only) echo 'disabled="disabled"'; ?> data-required="<?php if(!$required) echo 'no'; else echo 'yes';?>" class="wpuef_input_date wpuef_element" type="text" value="<?php echo $field_value; ?>" placeholder="<?php echo $placeholder; ?>" name="wpuef_options[<?php echo $extra_field->cid; ?>]" <?php if($required) echo 'required="required"';?>></input>
		<?php elseif($extra_field->field_type == "time"): ?>
			 <input <?php if($read_only) echo 'disabled="disabled"'; ?> data-required="<?php if(!$required) echo 'no'; else echo 'yes';?>" class="wpuef_input_time wpuef_element" type="text" value="<?php echo $field_value; ?>" placeholder="<?php echo $placeholder; ?>"  name="wpuef_options[<?php echo $extra_field->cid; ?>]" <?php if($required) echo 'required="required"';?>></input>
		
		<?php elseif($extra_field->field_type == "website"): ?>
			<input <?php if($read_only) echo 'disabled="disabled"'; ?> data-required="<?php if(!$required) echo 'no'; else echo 'yes';?>" class="input-text wpuef_input_url wpuef_element" type="url" value="<?php echo $field_value; ?>" placeholder="<?php echo $placeholder; ?>" name="wpuef_options[<?php echo $extra_field->cid; ?>]" <?php if($required) echo 'required="required"';?>></input>

		<?php elseif($extra_field->field_type == "paragraph" || ($extra_field->field_type == "html" && !$read_only) ): ?>
			<textarea  <?php if($read_only) echo 'disabled="disabled"'; ?> data-required="<?php if(!$required) echo 'no'; else echo 'yes';?>" class="wpuef_input_textarea wpuef_element" name="wpuef_options[<?php echo $extra_field->cid; ?>]" placeholder="<?php echo $placeholder; ?>"  <?php if($required) echo 'required="required"';?>><?php echo $field_value; ?></textarea>
		...
		<?php elseif($extra_field->field_type == "number"): ?>
			<input <?php if($read_only) echo 'disabled="disabled"'; ?> class="wpuef_input_number wpuef_element" data-required="<?php if(!$required) echo 'no'; else echo 'yes';?>" type="<?php echo $extra_field->field_type; ?>" placeholder="<?php echo $placeholder; ?>"  value="<?php echo $field_value; ?>" name="wpuef_options[<?php echo $extra_field->cid; ?>]" <?php if(isset($extra_field->field_options->min)) echo 'min="'.$extra_field->field_options->min.'"'?>  <?php if(isset($extra_field->field_options->max)) echo 'max="'.$extra_field->field_options->max.'"'?>  <?php if($required) echo 'required="required"';?>/>
		<?php elseif($extra_field->field_type != "title_no_input"): ?>
			<input <?php if($read_only) echo 'disabled="disabled"'; ?> class="input-text wpuef_input_text wpuef_element <?php echo $password_class; ?>" data-required="<?php if(!$required) echo 'no'; else echo 'yes';?>" type="<?php if($is_password_override) echo 'password'; else echo $extra_field->field_type; ?>" placeholder="<?php echo $placeholder; ?>"  value="<?php if(!$is_password_override) echo $field_value; ?>" name="<?php if($is_password_override) echo $password_field_name; else echo 'wpuef_options['.$extra_field->cid.']'; ?>" <?php if($required) echo 'required="required"';?>/>
		<?php endif; 
		//End types
		?>
