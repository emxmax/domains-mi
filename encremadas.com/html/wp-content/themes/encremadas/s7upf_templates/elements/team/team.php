<div class="item-about-team text-center <?php echo esc_attr($el_class)?>">
	<div class="about-team-thumb">
		<a href="<?php echo esc_url($link)?>" class="round"><?php echo wp_get_attachment_image($image,'full',0,array('class'=>'round'))?></a>
	</div>
	<div class="about-team-info">
		<?php if(!empty($title)):?><h3 class="title18 font-bold"><a href="<?php echo esc_url($link)?>" class="color"><?php echo esc_html($title)?></a></h3><?php endif;?>
