...
<div class="tabs-block block-element <?php echo esc_attr($el_class)?> tab-ajax-<?php echo esc_attr($tab_ajax)?>">
	<?php    
        if(!empty($title)) echo '<h3 class="block-title title30 font-bold lora-font">'.esc_html($title).'</h3>';
	...
	<div class="tab-header">
		<ul class="title-tab <?php echo esc_attr($tab_align)?> list-inline-block">
			<?php
