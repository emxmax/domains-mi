...
<?php if ( ! WC()->cart->is_empty() ) : ?>
    ...
    <div class="mini-cart-total text-uppercase title18 clearfix">
        <span class="pull-left"><?php esc_html_e( 'TOTAL', 'skincare' ); ?></span>
...
<?php else : ?>
    ...
    <div class="mini-cart-empty text-center">
		...
		<p class="desc title18"><?php esc_html_e( 'No hay productos en el carrito.', 'skincare' ); ?></p>
		<a href="<?php echo get_permalink( wc_get_page_id( 'shop' ) ); ?>" class="shop-button black"><?php esc_html_e('Ir a tienda','skincare');?></a>
	</div>
