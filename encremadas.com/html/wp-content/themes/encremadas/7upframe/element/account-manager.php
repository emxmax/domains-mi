...
vc_map( array(
	"name"      => esc_html__("Account manager", 'skincare'),
	...
	"params"    => array(
		...
		array(
			"type"          => "dropdown",
			"heading"       => esc_html__("Popup form",'skincare'),
			"param_name"    => "popup",
			"value"         => array(
		...
		array(
			"type" => "textfield",
			"heading" => esc_html__("Login Url",'skincare'),
			"param_name" => "login_url",
			'description'   => esc_html__( 'Enter login url. Default is myaccount page.', 'skincare' ),
		...
		array(
            'type'          => 'iconpicker',
            'heading'       => esc_html__( 'Login Icon', 'skincare' ),
		...
		array(
			"type" => "textfield",
			"heading" => esc_html__("Register Url",'skincare'),
		...
		array(
            'type'          => 'iconpicker',
            'heading'       => esc_html__( 'Register Icon', 'skincare' ),
		...
		array(
			"type" => "textfield",
			"heading" => esc_html__("Logout Redirect Url",'skincare'),
			"param_name" => "redirect_url",
			'description'   => esc_html__( 'Enter url redirect when user logout. Default is home page.', 'skincare' ),
            'edit_field_class'=>'vc_col-sm-6 vc_column',
			'dependency'    => array(
				'element'   => 'style',
				'value'   => array('abc'),
		...
		array(
            'type'          => 'iconpicker',
            'heading'       => esc_html__( 'Logout Icon', 'skincare' ),
		...
		array(
			"type" => "param_group",
			"heading" => esc_html__("Add List Link",'skincare'),
			"param_name" => "list",
			"params"    => array(
				array(
					"type" => "textfield",
				...
				array(
					"type"          => "checkbox",
					"heading"       => esc_html__("Show with Role",'skincare'),
					"param_name"    => "roles",
					"value"         => s7upf_get_list_role(),
					'description'   =>  esc_html__( 'Check to show link with role. Default show with all roles.', 'skincare' ),
				),
			),
			'description' =>  esc_html__( 'List links only show when you was login.', 'skincare' ),
			'dependency'    => array(
				'element'   => 'style',
				'value'   => array('abc'),
			),
