...
if(defined('ICL_LANGUAGE_CODE') || class_exists('Polylang') || defined('QTX_VERSION')){
                    ...
                    if(defined('ICL_SITEPRESS_VERSION')){
                        ...
                        foreach ($wpml_lang as $lang) {
                            ...
                            if($lang['active']){
                                ...
                                if($flag == 'yes') $lang_active .=     '<img alt="'.esc_attr__("flag","skincare").'" src="'.esc_url($flag_url).'">';
                            ...
                            $lang_sub .=                '<li class="'.$l_class.'">
                                                            <a href="'.esc_url($url).'">';
                            if($flag == 'yes') $lang_sub .=     '<img alt="'.esc_attr__("flag","skincare").'" src="'.esc_url($flag_url).'">';
                            $lang_sub .=                        $name;
                            $lang_sub .=                    '</a>
                                                        </li>';
                        }
    ...
    vc_map( array(
        "name"          => esc_html__("Language Selector", 'skincare'),
        "base"          => "s7upf_language_selector",
        "icon"          => "icon-st",
        "category"      => esc_html__("7UP-Elements", 'skincare'),
        "description"   => esc_html__( 'Display language selector', 'skincare' ),
        "params"    => array(
            array(
                "type"          => "dropdown",
                "admin_label"   => true,
                ...
                "value"         => array(
                    ...
                    esc_html__("Wpml style",'skincare')        => 'wpml-style',
                    esc_html__("Polylang style",'skincare')    => 'poly-style',
                ),
            ...
            array(
                "type"          => "dropdown",
                "admin_label"   => true,
                "heading"       => esc_html__("Show Flag",'skincare'),
                "param_name"    => "flag",
                "value"         => array(
