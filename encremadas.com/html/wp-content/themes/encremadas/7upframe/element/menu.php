...
vc_map( array(
    "name"          => esc_html__("Menu", 'skincare'),
    "base"          => "s7upf_menu",
    "icon"          => "icon-st",
    "category"      => esc_html__("7UP-Elements", 'skincare'),
    "description"   => esc_html__( 'Display menu navigation', 'skincare' ),
    "params"        => array(
        array(
            "type"          => "dropdown",
            "admin_label"   => true,
        ...
        array(
            "type"          => "dropdown",
            "admin_label"   => true,
            "heading"       => esc_html__("Menu Sticky",'skincare'),
            "param_name"    => "menu_sticky",
            "value"         => array(
                esc_html__("Off",'skincare')   => '',
                esc_html__("On",'skincare')   => 'menu-sticky-on',
            ),
            "description"   => esc_html__( 'Choose menu style to display.', 'skincare' )
        ),
        array(
            'type'          => 'dropdown',
            "admin_label"   => true,
            'heading'       => esc_html__( 'Menu name', 'skincare' ),
            'param_name'    => 'menu',
            'value'         => s7upf_list_menu_name(),
            'description'   => esc_html__( 'Select Menu name to display.', 'skincare' )
        ),        
        array(
            "type"          => "textfield",
