...
if(!class_exists('S7upf_Category_Fillter') && class_exists("woocommerce"))
{
    class S7upf_Category_Fillter extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct( false, esc_html__('7uptheme Categories Filter','skincare'),
                    ...
                    echo        '<ul class="list-attr-filter">';                
                        ...
                        foreach ($category as $cat_slug) {
                            ...
                            if(is_object($cat)){
                                ...
                                echo        '<li><a data-cat='.esc_attr($cat->slug).' href="'.esc_url(s7upf_get_filter_url('product_cat',$cat->slug)).'" class="load-shop-ajax '.$active.'">'.$cat->name.'</a><span class="count">'.$cat->count.'</span></li>';
                            }
                        }
                    echo      '</ul>';
                }      
        ...
        function form( $instance ) {
            ...
            <p>
                <label><?php esc_html_e( 'Categories:' ,'skincare'); ?></label></br>
                <?php 
                ...
                else echo esc_html__("No any category.","skincare");
                ?>
            </p>            
        <?php
        }
