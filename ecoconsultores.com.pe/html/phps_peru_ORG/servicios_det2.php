...
mysql_select_db($database_conec, $conec);
$query_menus2 = "SELECT * FROM peru_servicios2 ORDER BY id ASC";
$menus2 = mysql_query($query_menus2, $conec) or die(mysql_error());
...
mysql_select_db($database_conec, $conec);
$query_info_ser1 = sprintf("SELECT * FROM peru_servicios2 WHERE id = %s", GetSQLValueString($colname_info_ser1, "int"));
    ...
    <td align="center" valign="top"><table width="990" height="155" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="left" valign="top"><table width="990" height="155" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="270" align="left" valign="top"><img src="../imgs/logo_eco_consultores_peru.jpg" width="270" height="155" /></td>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','500','height','60','src','../swfs_peru/mapas_peru','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../swfs_peru/mapas_peru' ); //end AC code
              ...
              <tr>
                <td height="40" align="right" valign="top"><table width="582" height="40" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="15" align="right" valign="top"><img src="../imgs/borde.gif" width="15" height="28" /></td>
                    <td width="547" align="left" valign="top"><span class="preload1"></span>
                        <ul id="nav">
                          ...
                          <li class="top"><a href="servicios.php" id="services" class="top_link"><span class="Estilo1">Servicios</span></a></li>
          ...
          <td align="left" valign="top"><table width="990" height="453" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" valign="top"><table width="970" height="30" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="left" valign="top"><img src="../imgs/peru_servicios.jpg" width="970" height="30" /></td>
                </tr>
              </table>
                  ...
                  <tr>
                    <td width="224" align="left" valign="top"><table width="215" height="25" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td width="205" align="center" valign="top" bgcolor="#DCDCDC"><table width="195" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><div align="center"><span class="tx_1">Consultoría Gestíon de la Comunicación Interna</span></div></td>
                          </tr>
                        </table>
                      ...
                      <table width="215" height="25" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="10" align="left">&nbsp;</td>
                          <td width="205" align="center" valign="top" bgcolor="#DCDCDC"><table width="195" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td height="25"><div align="center"><span class="tx_1">Programas de Formación</span></div></td>
                              </tr>
                            </table>
                              <table border="0" cellpadding="0" cellspacing="0" width="205">
                                <!-- fwtable fwsrc="pper.png" fwpage="Página 1" fwbase="de.jpg" fwstyle="Dreamweaver" fwdocid = "1684877339" fwnested="0" -->
                                ...
                                <tr>
                                  <td height="6" colspan="3" align="left" valign="top"><img name="de_r1_c1" src="../imgs/mar/de_r1_c1.jpg" width="205" height="6" border="0" id="de_r1_c" alt="" /></td>
                                  <td><img src="../imgs/mar/spacer.gif" width="1" height="6" border="0" alt="" /></td>
                                </tr>
                                <tr>
                                  <td background="../imgs/mar/de_r2_c1.jpg">&nbsp;</td>
                                  <td align="left" valign="middle" bgcolor="#959595"><div class="tex_bl2" id="links_blan"><strong><a href="servicios_det2.php?id=<?php echo $row_menus2['id']; ?>#p"><?php echo $row_menus2['titulo']; ?></a></strong></div></td>
                                  <td background="../imgs/mar/de_r2_c3.jpg">&nbsp;</td>
                                  <td><img src="../imgs/mar/spacer.gif" width="1" height="10" border="0" alt="" /></td>
                                </tr>
                                <tr>
                                  <td height="6" colspan="3" align="left" valign="top"><img name="de_r3_c1" src="../imgs/mar/de_r3_c1.jpg" width="205" height="6" border="0" id="de_r3_c2" alt="" /></td>
                                  <td><img src="../imgs/mar/spacer.gif" width="1" height="6" border="0" alt="" /></td>
                                </tr>
                            </table></td>
                        </tr>
                    ...
                    <td width="746" align="left" valign="top"><table width="746" height="379" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="24" colspan="3"><a name="p" id="p"></a><strong class="tx_12" ><span class="tx_12a">&nbsp;Programas de Formación Gestión del Talento Humano</span></strong></td>
                          </tr>
                        <tr>
                          <td height="30" colspan="3" align="center" valign="middle"><table width="707" height="23" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td align="left" valign="middle" class="tit_eq"><?php echo $row_info_ser1['titulo']; ?></td>
                            </tr>
                          </table></td>
                          </tr>
                        <tr>
                          <td width="22" align="left" valign="top">&nbsp;</td>
                          <td width="388" align="left" valign="top" class="tex234"><span class="tx_2"><?php echo $row_info_ser1['text']; ?></span></td>
...
T. (51 1) 242 6984&nbsp;&nbsp;&nbsp; (51 1) 242 6642 &nbsp;&nbsp;&nbsp;•&nbsp;&nbsp;&nbsp;infoperu@ecocomunicaciones.com</td>
              <td>&nbsp;</td>
            </tr>
          </table></td>
        </tr>
