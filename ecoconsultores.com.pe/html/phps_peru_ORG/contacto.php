            ...
            <tr>
              <td height="401" align="center" valign="top"><table width="970" height="30" border="0" cellpadding="0" cellspacing="0">
                ...
                <table width="970" height="348" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="320" align="center" valign="top" background="../imgs/ecop.jpg"><span class="eco2"><a href="talento_humano_det.php?id=<?php echo $row_info['id']; ?>"></a></span>
                      <table width="914" height="293" border="0" cellpadding="0" cellspacing="0">
                        <tr>
