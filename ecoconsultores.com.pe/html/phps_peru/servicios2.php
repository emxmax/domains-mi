...
$query_menus1 = "SELECT * FROM peru_servicios2 ORDER BY id ASC";
          ...
          <td align="left" valign="top"><table width="990" height="453" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" valign="top"><table width="970" height="30" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="left" valign="top"><a name="p" id="p"></a><img src="../imgs/servicio2_peru.jpg" width="990" height="30" border="0" usemap="#Map" /></td>
                </tr>
              </table>
                        ...
                        <td width="205" align="center" valign="top" bgcolor="#DCDCDC"><?php do { ?>
                            <table border="0" cellpadding="0" cellspacing="0" width="205">
                              ...
                              <tr>
                                ...
                                <td align="left" valign="middle" bgcolor="#959595"><div class="tex_bl2" id="links_blan"><strong><a href="servicios2_det.php?id=<?php echo $row_menus1['id']; ?>#p"><?php echo $row_menus1['titulo']; ?></a></strong></div></td>
...
<map name="Map" id="Map">
  <area shape="rect" coords="847,5,980,27" href="../index_peru.php#p" />
</map>
<script type="text/javascript">
<!--
