            ...
            <tr>
              <td align="center" valign="top"><table width="970" height="30" border="0" cellpadding="0" cellspacing="0">
                ...
                <table width="970" height="412" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="800" height="384" align="center" valign="top"><table width="800" height="25" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="321">&nbsp;</td>
                        <td width="457" align="right" valign="middle"><div class="tex_bl2" id="linksINF"> <span class="tx_1">
                          <?php
...
do {
   ...
   ?>
                          <td width="825"><table width="786" height="235" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center" valign="top"><table width="777" height="238" border="0" cellpadding="0" cellspacing="0" bordercolor="0">
                                    <tr>
                                      <td width="805" height="218" align="center" valign="top"><table width="767" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td height="13"><img src="../imgs/tes1.jpg" width="767" height="13" /></td>
                                        </tr>
                                      </table>
                                        <table width="757" height="53" border="0" cellpadding="0" cellspacing="0">
                                          <tr>
                                            <td width="775" height="13" align="center" valign="top" bgcolor="#F4EBEE"><table width="744" height="199" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td width="213" align="center" valign="top"><span class="tit_eq"><a href="talento_humano_det.php?id=<?php echo $row_info['id']; ?>#p"><img src="../manager/imgs_dinamicas/imgs_peru_testimonios/<?php echo $row_info['img']; ?> " width="185" height="185" border="0" /></a></span></td>
                                                <td width="521" align="left" valign="top"><table width="513" height="29" border="0" cellpadding="0" cellspacing="0">
                                                  <tr>
                                                    <td align="left" valign="middle"><strong class="tx_1"><?php echo $row_info['titulo']; ?></strong></td>
                                                  </tr>
                                                </table>
                                                  <table width="514" height="162" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                      <td width="514" align="left" valign="top"><strong class="tex234"></strong>
                                        ...
                                        <table width="767" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td height="14"><img src="../imgs/tes3.jpg" width="767" height="14" /></td>
                                          </tr>
                                        </table></td>
                                    </tr>
                                    <tr>
