                  ...
                  <tr>
                    <td width="800" align="center" valign="top"><table >
                      <tr>
                        <?php
$info_endRow = 0;
$info_columns = 4; // number of columns
$info_hloopRow1 = 0; // first row flag
do {
    if($info_endRow == 0  && $info_hloopRow1++ != 0) echo "<tr>";
   ?>
                        <td><table width="167" height="195" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td align="center" valign="middle"><table width="154" height="175" border="1" cellpadding="1" cellspacing="0" bordercolor="#EAEAEA">
                                  <tr>
                                    <td align="center" valign="middle"><table width="143" height="172" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          <td height="134" align="center" valign="middle"><span class="tit_eq"><a href="talento_humano_det.php?id=<?php echo $row_info['id']; ?>#p"><img src="../manager/imgs_dinamicas/imgs_peru_equipo/<?php echo $row_info['img']; ?> " width="106" height="119" border="0" /></a></span></td>
                                        </tr>
                                        <tr>
                                          <td align="center" valign="middle" class="eco2"><div class="tex_bl2" id="linksINF"><strong><a href="talento_humano_det.php?id=<?php echo $row_info['id']; ?>#p"><?php echo $row_info['nombre']; ?></a></strong></div></td>
                                        </tr>
                                    </table></td>
                                  </tr>
                              </table></td>
...
echo("</tr>");
                      ...
                      <span class="eco2"><a href="talento_humano_det.php?id=<?php echo $row_info['id']; ?>"></a></span></td>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','170','height','210','src','../swfs_peru/videos','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../swfs_peru/videos' ); //end AC code
      ...
      <table width="990" height="68" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="68" align="left" valign="middle" background="../imgs/logo_eco_consultores_inferior.jpg"><table width="990" height="53" border="0" cellpadding="0" cellspacing="0">
            <tr>
