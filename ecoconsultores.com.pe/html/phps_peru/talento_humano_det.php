...
$query_info = "SELECT * FROM peru_equipo ORDER BY id ASC";
...
mysql_select_db($database_conec, $conec);
$query_info2 = sprintf("SELECT * FROM peru_equipo WHERE id = %s", GetSQLValueString($colname_info2, "int"));
          ...
          <td align="left" valign="top"><table width="990" height="453" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" valign="top"><a name="p" id="p"></a>
                ...
                <tr>
                  <td align="left" valign="top"><img src="../imgs/peru_talento_humano.jpg" width="970" height="30" /></td>
                </tr>
              </table>
                <table width="970" height="400" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="center" valign="top"><table width="970" height="383" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                              ...
                              <td width="205" align="center" valign="top" bgcolor="#DCDCDC"><?php do { ?>
                                  <table border="0" cellpadding="0" cellspacing="0" width="205">
                                    ...
                                    <tr>
                                      ...
                                      <td align="left" valign="middle" bgcolor="#959595"><div class="tex_bl2" id="links_blan"><strong><a href="talento_humano_det.php?id=<?php echo $row_info['id']; ?>#p"><?php echo $row_info['nombre']; ?></a></strong></div></td>
                        ...
                        <td width="746" align="left" valign="top"><table width="746" height="357" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="left" valign="top"><table width="747" height="318" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="577" align="center" valign="top"><table width="565" height="204" border="0" cellpadding="0" cellspacing="0">

                                    <tr>
                                      <td width="173" height="193" align="left" valign="middle" class="tit_eq"><img src="../manager/imgs_dinamicas/imgs_peru_equipo/<?php echo $row_info2['img']; ?> " width="171" height="191" /></td>
                                      <td width="10" align="left" valign="top">&nbsp;</td>
                                      <td width="382" align="left" valign="top"></td>
                                    </tr>
                                  </table>
                                    <table width="563" height="26" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td align="left" valign="top"><span class="tx_12a"><?php echo $row_info2['nombre']; ?></span></td>
                                      </tr>
                                    </table>
                                  <table width="562" height="21" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td height="21" align="left" valign="middle" class="tx_2"><div align="justify"><?php echo $row_info2['texto']; ?><br />
                                        </div></td>
                                      </tr>
                                  </table></td>
