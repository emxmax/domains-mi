...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE peru_servicios SET titulo=%s, img=%s, text=%s WHERE id=%s",
  ...
  $updateGoTo = "reporte_peru_servicios.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conec, $conec);
$query_foto2 = "SELECT * FROM peru_img_servicios ORDER BY id DESC";
...
mysql_select_db($database_conec, $conec);
$query_item = "SELECT * FROM peru_servicios_titulo ORDER BY id DESC";
...
mysql_select_db($database_conec, $conec);
$query_info = sprintf("SELECT * FROM peru_servicios WHERE id = %s", GetSQLValueString($colname_info, "int"));
                                                                                          ...
                                                                                          <table width="756" height="37" border="0" cellpadding="0" cellspacing="0">
                                                                                            <tr>
                                                                                              <td align="center" valign="middle"><label>
                                                                                                ...
                                                                                                <input name="item" type="hidden" id="item" value="<?php echo $row_info['item']; ?>" />
                                                                                              </label></td>
                                                                                            </tr>
                                                                                          </table>
