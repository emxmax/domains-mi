...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO peru_servicios_titulo (id, titulo) VALUES (%s, %s)",
  ...
  $insertGoTo = "reporte_peru_item_servicios.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
Crear Item para &quot;SERVICIOS&quot;<span class="eco"><br />
                              <br />
                              </span></strong></td>
                          </tr>
                        </table>
