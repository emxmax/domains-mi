...
$query_info = "SELECT * FROM peru_servicios_titulo ORDER BY id DESC";
                    ...
                    <td align="left" valign="top" class="tit_c"><table width="790" height="290" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" valign="top"><table width="790" height="31" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center" valign="middle" class="tit_c"><strong>Items existentes para servicios</strong></td>
                          </tr>
                        </table>
                            ...
                            <table width="750" height="66" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td height="32" align="center" valign="middle" class="tit_c"><table width="740" height="43" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          <td width="526" align="center" valign="middle" class="tex_c"><table width="479" height="38" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td width="479" align="center" valign="middle"><strong><?php echo $row_info['titulo']; ?></strong></td>
                                              </tr>
                                                                                          </table>                                            
                                          <strong> </strong></td>
                                          <td width="214" align="center" valign="middle"><table width="200" height="21" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td width="100" align="center" valign="middle" bgcolor="#EFEFEF" class="tex_c"><div id="linksMa_linea"><a href="editar_peru_item_servicios.php?id=<?php echo $row_info['id']; ?>">Editar </a></div></td>
                                                <td width="100" align="center" valign="middle" bgcolor="#FFE6E6" class="tit_a"><div id="linksMaRed_linea"><a href="borrar_peru_item_servicios?id=<?php echo $row_info['id']; ?>">Borrar</a> </div></td>
                                              </tr>
                                          </table></td>
                                        </tr>
                                                                  </table></td>
