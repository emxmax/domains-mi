...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO peru_servicios_programas (id, servicio, img, texto) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "reporte_peru_servicio_programas.php";
  if (isset($_SERVER['QUERY_STRING'])) {
                        ...
                        <td align="left" valign="top"><table width="790" height="31" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center" valign="middle" class="tit_c"><strong>PERU<br />
                              Crear Servicio PROGRAMAS DE FORMACION<span class="eco"><br />
                              <br />
                              </span></strong></td>
                          </tr>
                        </table>
                                            ...
                                            <table width="746" height="72" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td height="20" align="center" valign="top"><span class="tit_c">Nombre o titulo del servicio</span><br />
                                                  <br />
                                                  <label>
                                                  <input name="servicio" type="text" class="tex_c" id="servicio" size="70" />
                                                  </label>
                                                  <br />
                                                  <br />
                                                  <br /></td>
...
do {  
?>
                                                        <option value="<?php echo $row_fotos2['foto']?>"><?php echo $row_fotos2['foto']?></option>
                                                        <?php
