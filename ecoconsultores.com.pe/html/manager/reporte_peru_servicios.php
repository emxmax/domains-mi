...
$query_info = "SELECT * FROM peru_servicios ORDER BY id DESC";
...
Reporte &quot;SERVICIOS CONSULTORIA&quot;</strong></td>
                          </tr>
                        </table>
                                    ...
                                    <td height="32" align="center" valign="middle" class="tit_c"><table width="740" height="43" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          ...
                                          <td width="214" align="center" valign="middle"><table width="200" height="21" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td width="100" align="center" valign="middle" bgcolor="#EFEFEF" class="tex_c"><div id="linksMa_linea"><a href="editar_peru_servicios.php?id=<?php echo $row_info['id']; ?>">Editar </a></div></td>
                                                <td width="100" align="center" valign="middle" bgcolor="#FFE6E6" class="tit_a"><div id="linksMaRed_linea"><a href="borrar_peru_servicios.php?id=<?php echo $row_info['id']; ?>">Borrar</a> </div></td>
                                              </tr>
                                          </table></td>
                                        </tr>
                                                                  </table></td>
