...
$query_info = "SELECT * FROM peru_servicios3 ORDER BY id DESC";
...
Reporte &quot;GESTIÓN PARA EL DESARROLLO HUMANO &quot;</strong></td>
                          </tr>
                        </table>
                                        ...
                                        <tr>
                                          <td width="526" align="center" valign="middle" class="tex_c"><table width="525" height="38" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                ...
                                                <td width="515" align="center" valign="middle"><strong><?php echo $row_info['titulo']; ?></strong></td>
                                              </tr>
                                                                                          </table>                                            
                                          <strong> </strong></td>
                                          <td width="214" align="center" valign="middle"><table width="200" height="21" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td width="100" align="center" valign="middle" bgcolor="#EFEFEF" class="tex_c"><div id="linksMa_linea"><a href="editar_peru_servicios3.php?id=<?php echo $row_info['id']; ?>">Editar </a></div></td>
                                                <td width="100" align="center" valign="middle" bgcolor="#FFE6E6" class="tit_a"><div id="linksMaRed_linea"><a href="borrar_peru_servicios3.php?id=<?php echo $row_info['id']; ?>">Borrar</a> </div></td>
                                              </tr>
                                          </table></td>
                                        </tr>
                                                                  </table></td>
