...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE peru_nosotros SET img=%s, text=%s, titulo=%s WHERE id=%s",
  ...
  $updateGoTo = "reporte_peru_nosotros.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conec, $conec);
$query_info = sprintf("SELECT * FROM peru_nosotros WHERE id = %s", GetSQLValueString($colname_info, "int"));
                        ...
                        <td align="left" valign="top"><table width="790" height="31" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center" valign="middle" class="tit_c"><strong>PERU<br />
                              Editar &quot;NOSOTROS&quot;<span class="eco"><br />
                              </span></strong></td>
                          </tr>
                        </table>
                                                      ...
                                                      <tr>
                                                        <td width="350" align="left" valign="top"><?php do { ?>
                                                            <table width="350" height="39" border="0" cellpadding="0" cellspacing="0">
                                                              <tr>
                                                                <td width="46" height="31" align="center" valign="middle"><img src="imgs_dinamicas/imgs_peru_nosotros/<?php echo $row_foto['foto']; ?>" width="36" height="27" /></td>
                                            ...
                                            <table width="746" height="71" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td height="20" align="center" valign="top"><p><span class="tit_c">Titulo</span><br />
                                                  ...
                                                  <p>
                                                    <label>
                                                    <input name="nombre" type="text" class="tex_c" id="nombre" value="<?php echo $row_info['titulo']; ?>" size="80" />
                                                    </label>
                                                    <br />
                                                    </p></td>
                                              </tr>
                                            ...
                                            <table width="746" height="146" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td height="20" align="center" valign="top"><span class="tit_c">Información</span><br />
                                                  <br />
                                                  <textarea name="texto" cols="45" rows="5" class="ckeditor" id="texto"><?php echo $row_info['text']; ?></textarea></td>
                                              </tr>
                                            </table>
                                          </div>
                                      </div>
