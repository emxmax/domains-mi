...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE peru_equipo SET img=%s, nombre=%s, texto=%s WHERE id=%s",
  ...
  $updateGoTo = "reporte_peru_equipo.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conec, $conec);
$query_info = sprintf("SELECT * FROM peru_equipo WHERE id = %s", GetSQLValueString($colname_info, "int"));
                        ...
                        <td align="left" valign="top"><table width="790" height="31" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center" valign="middle" class="tit_c"><strong>PERU<br />
                              Editar integrante<span class="eco"><br />
                              </span></strong></td>
                          </tr>
                        </table>
                                  ...
                                  <tr>
                                    <td align="left" valign="top"><div id="tabs">
                                        <ul>
                                          ...
                                          <li class="tex_c"><a href="#tabs-2" >Nombre</a></li>
                                          <li class="tex_c"><a href="#tabs-4" >Perfil</a></li>
                                                      ...
                                                      <tr>
                                                        <td width="350" align="left" valign="top"><?php do { ?>
                                                            <table width="350" height="39" border="0" cellpadding="0" cellspacing="0">
                                                              <tr>
                                                                <td width="46" height="31" align="center" valign="middle"><img src="imgs_dinamicas/imgs_peru_equipo/<?php echo $row_foto['foto']; ?>" width="36" height="27" /></td>
...
do {  
?>
                                                          <option value="<?php echo $row_foto2['foto']?>"<?php if (!(strcmp($row_foto2['foto'], $row_info['img']))) {echo "selected=\"selected\"";} ?>><?php echo $row_foto2['foto']?></option>
                                                          <?php
                                       ...
                                       <div class="tex_c" id="tabs-2">
                                          <div align="left">
                                            <table width="746" height="71" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td height="20" align="center" valign="top"><p><span class="tit_c">Nombre</span><br />
                                                    </p>
                                                  <p>
                                                    <label>
                                                    <input name="nombre" type="text" class="tex_c" id="nombre" value="<?php echo $row_info['nombre']; ?>" size="80" />
                                                    </label>
                                                    <br />
                                                    </p></td>
                                              </tr>
                                       ...
                                       <div class="tex_c" id="tabs-4">
                                          <div align="left">
                                            <table width="746" height="146" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td height="20" align="center" valign="top"><span class="tit_c">Argumentos profesionales</span><br />
                                                  <br />
