...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO peru_videos (id, img, titulo, link) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "reporte_peru_videos.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conec, $conec);
$query_item = "SELECT * FROM peru_videos ORDER BY id DESC";
                                                  ...
                                                  <table width="721" height="88" border="0" cellpadding="0" cellspacing="0">
                                                      <tr>
                                                        ...
                                                        <td width="361" align="center" valign="top">
                                                          <select name="img" class="tex_c" id="img">
