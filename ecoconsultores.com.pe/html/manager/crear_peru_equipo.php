...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO peru_equipo (id, img, nombre, texto) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "reporte_peru_equipo.php";
  if (isset($_SERVER['QUERY_STRING'])) {
                        ...
                        <td align="left" valign="top"><table width="790" height="31" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center" valign="middle" class="tit_c"><strong>PERU<br />
                              Crear nuevo integrante<span class="eco"><br />
                              </span></strong></td>
                          </tr>
                        </table>
                                                  ...
                                                  <table width="721" height="88" border="0" cellpadding="0" cellspacing="0">
                                                      <tr>
                                                        ...
                                                        <td width="361" align="center" valign="top"><select name="img" class="tex_c" id="img">
                                                          <option value="value">Imagenes</option>
                                                          <?php
do {  
?>
                                                          <option value="<?php echo $row_foto2['foto']?>"><?php echo $row_foto2['foto']?></option>
                                                          <?php
                                            ...
                                            <table width="746" height="71" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td height="20" align="center" valign="top"><p><span class="tit_c">Nombre</span><br />
                                                  ...
                                                  <p>
                                                    <label>
                                                    <input name="nombre" type="text" class="tex_c" id="nombre" size="80" />
                                                    </label>
                                                    <br />
                                                    </p></td>
                                              </tr>
                                            ...
                                            <table width="746" height="146" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td height="20" align="center" valign="top"><span class="tit_c">Argumentos profesionales</span><br />
                                                  <br />
                                                  <textarea name="texto" cols="45" rows="5" class="ckeditor" id="texto"></textarea></td>
                                              </tr>
                                            </table>
                                          </div>
                                      </div>
