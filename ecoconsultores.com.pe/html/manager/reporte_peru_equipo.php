...
$query_info = "SELECT * FROM peru_equipo ORDER BY id DESC";
                                    ...
                                    <td height="32" align="center" valign="middle" class="tit_c"><table width="740" height="43" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          <td width="526" align="center" valign="middle" class="tex_c"><table width="515" height="38" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td width="40" align="center" valign="middle"><img src="imgs_dinamicas/imgs_peru_equipo/<?php echo $row_info['img']; ?> " width="36" height="27" /></td>
                                                <td width="475" align="center" valign="middle"><strong><?php echo $row_info['nombre']; ?></strong></td>
                                              </tr>
                                                                                          </table>                                            
                                          <strong> </strong></td>
                                          <td width="214" align="center" valign="middle"><table width="200" height="21" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td width="100" align="center" valign="middle" bgcolor="#EFEFEF" class="tex_c"><div id="linksMa_linea"><a href="editar_peru_equipo.php?id=<?php echo $row_info['id']; ?>">Editar </a></div></td>
                                                <td width="100" align="center" valign="middle" bgcolor="#FFE6E6" class="tit_a"><div id="linksMaRed_linea"><a href="borrar_peru_equipo.php?id=<?php echo $row_info['id']; ?>">Borrar</a> </div></td>
                                              </tr>
                                          </table></td>
                                        </tr>
                                                                  </table></td>
