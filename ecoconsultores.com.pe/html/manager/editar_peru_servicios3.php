...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE peru_servicios3 SET titulo=%s, img=%s, text=%s WHERE id=%s",
  ...
  $updateGoTo = "reporte_peru_servicios3.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conec, $conec);
$query_info = sprintf("SELECT * FROM peru_servicios3 WHERE id = %s", GetSQLValueString($colname_info, "int"));
                        ...
                        <td align="left" valign="top"><table width="790" height="31" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center" valign="middle" class="tit_c"><strong>PERU<br />
                              Editar &quot;GESTIÓN PARA EL DESARROLLO HUMANO &quot;<span class="eco"><br />
                              </span></strong></td>
                          </tr>
                        </table>
