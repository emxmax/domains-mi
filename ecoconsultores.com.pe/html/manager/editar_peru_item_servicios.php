...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE peru_servicios_titulo SET titulo=%s WHERE id=%s",
  ...
  $updateGoTo = "reporte_peru_item_servicios.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conec, $conec);
$query_info = sprintf("SELECT * FROM peru_servicios_titulo WHERE id = %s", GetSQLValueString($colname_info, "int"));
...
Editar Item para &quot;SERVICIOS&quot;<span class="eco"><br />
                              <br />
                              </span></strong></td>
                          </tr>
                        </table>
                                            ...
                                            <table width="746" height="72" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td height="20" align="center" valign="top"><span class="tit_c">Nombre o titulo del item</span><br />
                                                  <br />
                                                  <label>
                                                  <input name="titulo" type="text" class="tex_c" id="titulo" value="<?php echo $row_info['titulo']; ?>" size="70" />
                                                  </label>
                                                  <br />
                                                  <br />
                                                  <br /></td>
