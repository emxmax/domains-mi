...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE peru_testimonios SET titulo=%s, img=%s, text=%s WHERE id=%s",
  ...
  $updateGoTo = "reporte_peru_testimonios.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conec, $conec);
$query_foto = "SELECT * FROM peru_img_testimonios ORDER BY id DESC";
$foto = mysql_query($query_foto, $conec) or die(mysql_error());
$row_foto = mysql_fetch_assoc($foto);
$totalRows_foto = mysql_num_rows($foto);

mysql_select_db($database_conec, $conec);
$query_foto2 = "SELECT * FROM peru_img_testimonios ORDER BY id DESC";
...
mysql_select_db($database_conec, $conec);
$query_info = sprintf("SELECT * FROM peru_testimonios WHERE id = %s", GetSQLValueString($colname_info, "int"));
                        ...
                        <td align="left" valign="top"><table width="790" height="31" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center" valign="middle" class="tit_c"><strong>PERU<br />
                              Editar &quot;TESTIMONIO&quot;<span class="eco"><br />
                              </span></strong></td>
                          </tr>
                        </table>
                                  ...
                                  <tr>
                                    <td align="left" valign="top"><div id="tabs">
                                        <ul>
                                          ...
                                          <li class="tex_c"><a href="#tabs-2" >Titulo</a></li>
                                                      ...
                                                      <tr>
                                                        <td width="350" align="left" valign="top"><?php do { ?>
                                                            <table width="350" height="39" border="0" cellpadding="0" cellspacing="0">
                                                              <tr>
                                                                <td width="46" height="31" align="center" valign="middle"><img src="imgs_dinamicas/imgs_peru_testimonios/<?php echo $row_foto['foto']; ?>" width="36" height="27" /></td>
                                            ...
                                            <table width="746" height="71" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td height="20" align="center" valign="top"><p><span class="tit_c">Titulo</span><br />
                                                  ...
                                                  <p>
                                                    <label>
                                                    <input name="titulo" type="text" class="tex_c" id="titulo" value="<?php echo $row_info['titulo']; ?>" size="80" />
                                                    </label>
                                                    <br />
                                                    </p></td>
                                              </tr>
                                            ...
                                            <table width="746" height="146" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td height="20" align="center" valign="top"><span class="tit_c">Información</span><br />
                                                  <br />
                                                  <textarea name="text" cols="45" rows="5" class="ckeditor" id="text"><?php echo $row_info['text']; ?></textarea></td>
                                              </tr>
                                            </table>
                                          </div>
                                      </div>
