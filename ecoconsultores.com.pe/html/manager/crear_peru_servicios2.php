...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO peru_servicios2 (id, titulo, img, text) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "reporte_peru_servicios2.php";
  if (isset($_SERVER['QUERY_STRING'])) {
                        ...
                        <td align="left" valign="top"><table width="790" height="31" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center" valign="middle" class="tit_c"><strong>PERU<br />
                              crear &quot;SERVICIO PROGRAMAS DE...&quot;<span class="eco"><br />
                              </span></strong></td>
                          </tr>
                        </table>
