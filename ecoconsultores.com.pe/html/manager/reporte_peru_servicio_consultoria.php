...
$query_servicios = "SELECT * FROM peru_servicios_consultoria ORDER BY id DESC";
                        ...
                        <td align="center" valign="top"><table width="790" height="31" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center" valign="middle" class="tit_c"><strong>PERU<br />
                              Servicios existentes CONSULTORIA</strong></td>
                          </tr>
                        </table>
                                  ...
                                  <td height="32" align="center" valign="middle" class="tit_c"><table width="649" height="23" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      ...
                                      <td width="206" align="center" valign="middle"><table width="200" height="21" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          <td width="100" align="center" valign="middle" bgcolor="#EFEFEF" class="tex_c"><div id="linksMa_linea"><a href="editar_servicio_peru_consultoria.php?id=<?php echo $row_servicios['id']; ?>">Editar Servicio</a></div></td>
                                          <td width="100" align="center" valign="middle" bgcolor="#FFE6E6" class="tit_a"><div id="linksMaRed_linea"><a href="borrar_servicio_peru_consultoria?id=<?php echo $row_servicios['id']; ?>" class="eco">Borrar Servicio</a></div></td>
                                        </tr>
                                      </table></td>
                                      </tr>
                                  </table></td>
