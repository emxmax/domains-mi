...
$query_servicios = "SELECT * FROM peru_servicios_programas ORDER BY id DESC";
$servicios = mysql_query($query_servicios, $conec) or die(mysql_error());
                        ...
                        <td align="center" valign="top"><table width="790" height="31" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center" valign="middle" class="tit_c"><strong>PERU<br />
                              Servicios existentes PROGRAMAS DE FORMACION</strong></td>
                          </tr>
                        </table>
                          <table width="790" height="19" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="65" align="center" valign="bottom" class="tit_c">&nbsp;</td>
                              <td width="443" align="center" valign="middle" bgcolor="#F0F0F0" class="tit_b"><strong>Nombre de servicio</strong></td>
                              <td width="9" align="center" valign="bottom" bgcolor="#E2E2E2" class="tit_c">&nbsp;</td>
                              <td width="201" align="center" valign="middle" bgcolor="#F0F0F0" class="tit_b"><strong>Accion</strong></td>
                              <td width="72" align="center" valign="bottom" class="tit_c">&nbsp;</td>
                            </tr>
                          </table>
                          <?php do { ?>
                            <table width="689" height="41" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td height="32" align="center" valign="middle" class="tit_c"><table width="649" height="23" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td width="443" align="center" valign="middle" class="tex_c"><strong> <?php echo $row_servicios['servicio']; ?>  </strong></td>
                                      <td width="206" align="center" valign="middle"><table width="200" height="21" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          <td width="100" align="center" valign="middle" bgcolor="#EFEFEF" class="tex_c"><div id="linksMa_linea"><a href="editar_servicio_peru_programas.php?id=<?php echo $row_servicios['id']; ?>">Editar Servicio</a></div></td>
                                          <td width="100" align="center" valign="middle" bgcolor="#FFE6E6" class="tit_a"><div id="linksMaRed_linea"><a href="borrar_servicio_peru_programas?id=<?php echo $row_servicios['id']; ?>" class="eco">Borrar Servicio</a></div></td>
                                        </tr>
                                      </table></td>
                                      </tr>
                                  </table></td>
                              ...
                              <tr>
                                <td height="7" align="center" valign="middle" class="tit_c"><img src="imgs_manager/linea.jpg" width="630" height="7" /></td>
                                </tr>
                                                          </table>
