            ...
            <tr>
              <td align="center" valign="top"><a name="p" id="p"></a>
                <table width="985" height="291" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="811" valign="top"><table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="500"><a href="http://www.ecoconsultores.com.pe/taller.pdf" target="_blank"><img src="taller.jpg" alt="III Taller de Certificación Thuoper Betesa" title="III Taller de Certificación Thuoper Betesa" width="500" height="383" border="0" /></a></td>
                        <td width="260" align="center" valign="top"><a href="http://www.ecoconsultores.com.pe/orden-inscripcion.xls" target="_blank"><img src="descargar.jpg" alt="Descargar Orden de Inscripción" title="Descargar Orden de Inscripción" width="150" height="180" border="0" /></a></td>
                      </tr>
                    </table></td>
                    <td width="174" align="right" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                      <tr>
