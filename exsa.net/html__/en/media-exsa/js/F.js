...
U.apiObjPost = function(funcion){
  //var url = "service/apipost.php";
  var url = "http://www.mediaimpact.pe/demo/exsa/admin/service/apipost.php";
  //var url = "http://exsa.net/en/admin/service/apipost.php";
  //var url = "http://logistikcourier.com.pe/logiService/service/apipost.php";
  //var url = "http://scdsistemas.com/proyectos/logistik/logiService/service/apipost.php";
  var obj = new Object();
  obj.f = funcion;
  obj.a = "";
