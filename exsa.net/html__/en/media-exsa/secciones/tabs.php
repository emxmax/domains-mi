				...
				<div class="panel panel-primary">
				  	<div class="panel-heading">Tabs <button class="nuevo btn btn-default" id="btnNuevaPagina" data-form="nuevaPagina"><span class="glyphicon glyphicon-plus"></span> Nuevo</button></div>
