		...
		<div class="container">
			<div class="row centro">
				...
				<div class="col-md-9 col-xs-12" style="text-align: right;">
					<p><span class="label"><a href="mapa-de-sitio" style="color: #ffffff;">Mapa de Sitio</a></span>
					<span class="label"><a href="http://mail.exsa.net" target="_blank" style="color: #ffffff;">Web Mail</a></span>
					<span class="label"><a href="trabaja-con-nosotros" style="color: #ffffff;">Trabaja con Nosotros</a></span>
					<span class="label"><a href="declaracion-de-privacidad-terminos-y-condiciones" style="color: #ffffff;">Declaración de Privacidad Términos y Condiciones</a></span></p>
				</div>
			</div>
		</div>
	</div>
