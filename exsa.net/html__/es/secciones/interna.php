		...
		<div class="container">
			...
			<div class="row">
				...
				?>
						...
						<?php
							if($seccion=="mapa-de-sitio"){
								include('secciones/mapa-de-sitio.php');
							}else{
						?>
								...
								<script>
									...
									$("#breadcrumb").append('<li><a href="sala-de-prensa">SALA DE PRENSA</a></li>');
									$("#breadcrumb").append('<li><a href="noticias">Noticias</a></li>');
									$("#breadcrumb").append('<li class="active">'+helper.url1()+'</li>');
								</script>
						<?php
							}
					}
