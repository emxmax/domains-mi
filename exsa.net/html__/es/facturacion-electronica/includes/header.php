<?php 
  define("_URL_", "https://exsa.net/facturacion-electronica/");
  $ar=explode("/",$_SERVER['REQUEST_URI']);$prosub=1;$df=explode(".",$ar[2]);
	  //print_r($ar);
	  	  switch($df[0]){
...
<head>
  ...
  <base href="https://exsa.net/facturacion-electronica/">
  <title>EXSA - Plataforma de Facturación Electrónica</title>
  <link href='https://fonts.googleapis.com/css?family=Play' rel='stylesheet' type='text/css'>
  <link href="<?php echo _URL_?>public/assets/css/style.css" rel="stylesheet" />
  <link rel="shortcut icon" href="https://exsa.net/wp-content/uploads/2013/09/favicon1.ico" type="image/x-icon" />
  <!--[if IE 7]>
   <style type="text/css">
