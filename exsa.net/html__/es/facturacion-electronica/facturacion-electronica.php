...
function doframe(r){
	...
	//alert(ifr_Alto);
	if(r==1){
		document.write('<div id="content_iframe"><iframe class = "miFrame" src = "https://coredobrasil.com.br/portalng/portaliframe.php?tenant=exsa&showTenantLogo=false" width="105%" height="' + espacio_iframe + '"  frameborder="0" transparency="transparency" onreadystatechange="dostate(this);" onload="doframe(2);"></iframe></div>');
...
<iframe frameborder="0" class = "miFrame" src="https://coredobrasil.com.br/portalng/portaliframe.php?tenant=exsa&showTenantLogo=false" width="105%" height=478> 
</iframe> 
</div>
</noscript>
</div>
