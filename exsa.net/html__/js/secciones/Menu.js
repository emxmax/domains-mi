function Menu()
{
	...
	function mostrarMenu(data)
	{
		...
		menu=data.items;
		$("#menuFooter").html('');
		$("#menuFooter").append('<p id="itemsMenuFooter">');
		$.each(menu, function( index, value ) {
			...
			url1=value.url;
			if(h1 != null){
				$("#itemsMenuFooter").append('<span class="yell"><a href="'+url1+'">'+d1+'</a></span>');
			...
			$("#itemsMenuFooter").append('<span class="yell"><a href="http://www.exsasoluciones.pe/" target="_blank">BLOG</a></span>');
		$("#menuFooter").append('</p>');
	}
}